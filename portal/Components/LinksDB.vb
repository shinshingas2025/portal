...
Namespace ASPNET.StarterKit.Portal
    ...
    Public Class LinkDB
        ...
        Public Function GetLinks(ByVal moduleId As Integer, ByVal sid As String) As SqlDataReader

            ' Create Instance of Connection and Command Object
            Dim myConnection As New SqlConnection(ConfigurationSettings.AppSettings("connectionString"))
            Dim myCommand As New SqlCommand("Portal_GetLinks", myConnection)
        ...
        Public Function GetSingleLink(ByVal itemId As Integer) As SqlDataReader
            ...
            ' Create Instance of Connection and Command Object
            Dim myConnection As New SqlConnection(ConfigurationSettings.AppSettings("connectionString"))
            Dim myCommand As New SqlCommand("Portal_GetSingleLink", myConnection)
        ...
        Public Sub DeleteLink(ByVal itemID As Integer)
            ...
            ' Create Instance of Connection and Command Object
            Dim myConnection As New SqlConnection(ConfigurationSettings.AppSettings("connectionString"))
            Dim myCommand As New SqlCommand("Portal_DeleteLink", myConnection)
        ...
        Public Function AddLink(ByVal moduleId As Integer, ByVal itemId As Integer, ByVal userName As String, ByVal title As String, ByVal url As String, ByVal mobileUrl As String, ByVal viewOrder As Integer, ByVal description As String, ByVal sid As String) As Integer
            ...
            ' Create Instance of Connection and Command Object
            Dim myConnection As New SqlConnection(ConfigurationSettings.AppSettings("connectionString"))
            Dim myCommand As New SqlCommand("Portal_AddLink", myConnection)
        ...
        Public Sub UpdateLink(ByVal moduleId As Integer, ByVal itemId As Integer, ByVal userName As String, ByVal title As String, ByVal url As String, ByVal mobileUrl As String, ByVal viewOrder As Integer, ByVal description As String)
            ...
            ' Create Instance of Connection and Command Object
            Dim myConnection As New SqlConnection(ConfigurationSettings.AppSettings("connectionString"))
            Dim myCommand As New SqlCommand("Portal_UpdateLink", myConnection)
