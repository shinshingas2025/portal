...
Namespace ASPNET.StarterKit.Portal
    ...
    Public Class AnnounceDB
        ...
        Public Function GetAnnounce(ByVal moduleId As Integer, ByVal sid As String) As DataSet

            ' Create Instance of Connection and Command Object
            Dim myConnection As New SqlConnection(ConfigurationSettings.AppSettings("connectionString"))
            Dim myCommand As New SqlDataAdapter("Portal_GetAnnounce_All", myConnection)
        ...
        Public Function GetEvents(ByVal moduleId As Integer, ByVal sid As String) As DataSet
            ...
            ' Create Instance of Connection and Command Object
            Dim myConnection As New SqlConnection(ConfigurationSettings.AppSettings("connectionString"))
            Dim myCommand As New SqlDataAdapter("Portal_GetAnnounce", myConnection)
        ...
        End Function
        Public Function GetEventsAll(ByVal moduleId As Integer, ByVal sid As String) As DataSet
        ...
        Public Function GetSingleAnnounce(ByVal itemId As Integer) As SqlDataReader

            ' Create Instance of Connection and Command Object
            Dim myConnection As New SqlConnection(ConfigurationSettings.AppSettings("connectionString"))
            Dim myCommand As New SqlCommand("Portal_GetSingleAnnounce", myConnection)
        ...
        Public Sub DeleteAnnounce(ByVal itemID As Integer)

            ' Create Instance of Connection and Command Object
            Dim myConnection As New SqlConnection(ConfigurationSettings.AppSettings("connectionString"))
            Dim myCommand As New SqlCommand("Portal_DeleteAnnounce", myConnection)
        ...
        Public Function AddAnnounce(ByVal moduleId As Integer, ByVal itemId As Integer, ByVal userName As String, ByVal title As String, ByVal expireDate As DateTime, ByVal description As String, ByVal wherewhen As String, ByVal sid As String) As Integer
            ...
            ' Create Instance of Connection and Command Object
            Dim myConnection As New SqlConnection(ConfigurationSettings.AppSettings("connectionString"))
            Dim myCommand As New SqlCommand("Portal_AddAnnounce", myConnection)
        ...
        Public Sub UpdateAnnounce(ByVal moduleId As Integer, ByVal itemId As Integer, ByVal userName As String, ByVal title As String, ByVal expireDate As DateTime, ByVal description As String, ByVal wherewhen As String)
            ...
            ' Create Instance of Connection and Command Object
            Dim myConnection As New SqlConnection(ConfigurationSettings.AppSettings("connectionString"))
            Dim myCommand As New SqlCommand("Portal_UpdateAnnounce", myConnection)
