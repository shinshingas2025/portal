...
Public Class WorkBO
    ...
    Public Function Query(Optional ByVal NO As String = "") As DataTable
        ...
        Dim dt As DataTable
        strSQL = "Select a.workno,a.workgroup,a.worksubject,a.workwkdate,a.workmember,a.workcontroler,a.workuser,convert(char(10),a.workdate,111) as workdate,a.*,b.it_name as wkgrpname,creater,edate,workaddress,sdate,tel,provider,checker,workwktime from workinfor a,item b where a.workgroup = b.no "
    ...
    Public Function Insert(ByVal Ne As Enwork) As Integer
        Dim strSQL As String = ""
        strSQL = "Insert into workinfor (workgroup,worksubject,workwkdate,workmember,workcontroler,workuser,workdate,creater,sdate,edate,provider,workaddress,tel,checker,workwktime,workwkdateend,workwktimeend) values ("
        strSQL &= "'" & Ne.workgroup & "'"
        ...
        strSQL &= ",'" & Ne.workwkdateend & "'"
        strSQL &= ",'" & Ne.workwktimeend & "'"
    ...
    Public Function Update(ByVal Ne As Enwork) As String
        ...
        If Ne.workwkdateend <> "" Then
            strSQLBody &= ",workwkdateend='" & Ne.workwkdateend & "'"

        End If
        If Ne.workwktimeend <> "" Then
            strSQLBody &= ",workwktimeend='" & Ne.workwktimeend & "'"
