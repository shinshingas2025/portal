...
Public Class NewApplyFormBO
    ...
    Public Function Update(ByVal entityID As String, ByVal status As String, ByVal myoperator As String) As Integer
        ...
        strSQL = "UPDATE NewApplyForm set ProcessTime=getdate(), status='" & status & "' ,operator='" & myoperator & "'"
    ...
    End Function
    '¶×¤JInformixªºsendID 
    Public Function Update(ByVal entityID As String, ByVal SendID As String) As Integer
        Dim strSQL As String

        strSQL = "UPDATE NewApplyForm set SendTime=getdate(), SendID='" & SendID & "'"
    ...
    Public Function QueryDate(ByVal status As String, ByVal AppSDATE As String, ByVal AppEDATE As String, ByVal ProSDATE As String, ByVal ProEDATE As String) As DataTable
        Dim strSQL As String = ""
        Dim dt As DataTable
        strSQL = "Select * ,isnull(SendTime,'') as SendTimeStr from NewApplyForm where status='" & status & "'"
    ...
    Public Function QueryByEntityID(ByVal EntityID As String) As DataTable
        Dim strSQL As String = ""
        Dim dt As DataTable
        strSQL = "Select *  from NewApplyForm where EntityID = '" & EntityID & "'"
