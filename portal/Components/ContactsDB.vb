...
Namespace ASPNET.StarterKit.Portal
    ...
    Public Class ContactsDB
        ...
        Public Function GetContacts(ByVal moduleId As Integer, ByVal sid As String) As DataSet
        ...
        Public Function AddContact(ByVal moduleId As Integer, ByVal itemId As Integer, ByVal userName As String, ByVal name As String, ByVal role As String, ByVal email As String, ByVal contact1 As String, ByVal contact2 As String, ByVal sid As String) As Integer
