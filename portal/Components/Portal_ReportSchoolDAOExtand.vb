...
Namespace ASPNET.StarterKit.Portal
	Public Class Portal_ReportSchoolDAOExtand
		Inherits Portal_ReportSchoolDAO
		Public Overrides Function GetEntitys(ByVal reportGroupID As String) As DataSet
			Dim myConnection As New SqlConnection(ConfigurationSettings.AppSettings("connectionString"))
			Dim myCommand As New SqlCommand("select * from Portal_ReportSchool where ReportGroupID=@ReportGroupID order by DisplayOrder", myConnection)
