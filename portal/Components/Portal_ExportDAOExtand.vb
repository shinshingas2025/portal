...
Namespace ASPNET.StarterKit.Portal
	Public Class Portal_ExportDAOExtand
		Inherits Portal_ExportDAO
		...
		Public Overloads Function GetEntitys(ByVal schoolID As String, ByVal moduleID As Integer, ByVal rowCount As Integer) As DataSet
			Dim myConnection As New SqlConnection(ConfigurationSettings.AppSettings("connectionString"))
			Dim myCommand As New SqlCommand("select top " & rowCount & " * from Portal_Export where SchoolID=@SchoolID and ModuleID=@ModuleID order by EntityID desc", myConnection)
		...
		Public Overloads Sub UpdateEntity(ByVal entityID As String, ByVal title As String, ByVal description As String)
			Dim myConnection As New SqlConnection(ConfigurationSettings.AppSettings("connectionString"))
			Dim myCommand As New SqlCommand("update Portal_Export set Title=@Title, Description=@Description where EntityID=@EntityID", myConnection)
