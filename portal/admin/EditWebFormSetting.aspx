...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="EditWebFormSetting.aspx.vb" Inherits="EditWebFormSetting" %>
									...
									<TR>
										<TD vAlign="top" align="center">
											...
											<TABLE class="TTable" id="Table5" borderColor="#000000" cellSpacing="0" borderColorDark="#ffffff"
													...
													<TD colSpan="2"><FONT face="新細明體">
															<TABLE id="Table3" cellSpacing="1" cellPadding="1" width="100%" border="0">
																<TR>
																	...
																	<TD style="WIDTH: 419px"><asp:button id="btnUpdate" runat="server" Text="修改索引" BorderStyle="Groove"></asp:button><asp:button id="btnDelete" runat="server" Text="刪除項目" BorderStyle="Groove"></asp:button><asp:button id="btnTreeRefresh" runat="server" Text="重新整理" BorderStyle="Groove" Font-Size="X-Small"></asp:button></TD>
													...
													<TD colSpan="2"><FONT face="新細明體">
															<TABLE id="Table6" cellSpacing="1" cellPadding="1" width="100%" border="0">
																<TR>
																	...
																	<TD><asp:textbox id="txtObjValue" runat="server" Font-Size="X-Small" Width="54px"></asp:textbox></TD>
																	<TD><FONT size="2">序號</FONT></TD>
																	<TD><asp:textbox id="txtSeqno" runat="server" Font-Size="X-Small" Width="27px"></asp:textbox></TD>
																	<TD><FONT size="2">狀態</FONT></TD>
																	<TD><asp:textbox id="txtState" runat="server" Font-Size="X-Small" Width="34px"></asp:textbox></TD>
																</TR>
															</TABLE>
														</FONT>
													</TD>
												...
												<TR>
													<TD style="WIDTH: 263px" bgColor="activeborder"><asp:label id="Label1" runat="server" Font-Size="X-Small">網站結構</asp:label></TD>
												...
												<TR>
													<TD style="WIDTH: 263px" vAlign="top"><asp:panel id="Panel1" runat="server" Height="380px">
															<iewc:treeview id="TreeView1" runat="server" ExpandLevel="1" AutoPostBack="True"></iewc:treeview>
														</asp:panel></TD>
													<TD vAlign="top" align="left">
														<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
															<TR>
																<TD><asp:datagrid id="DataGrid1" runat="server" BorderStyle="None" Font-Size="X-Small" Width="100%"
																		...
																		<TR>
																			...
																			<TD style="WIDTH: 15px" vAlign="bottom"><FONT face="新細明體">&nbsp;
																					<TABLE id="Table4" cellSpacing="0" cellPadding="0" width="100%" border="0">
																						...
																						<TR>
																							<TD><BR>
																								<asp:imagebutton id="LPaneUpdate" runat="server" ImageUrl="../images/edit.gif"></asp:imagebutton><BR>
																								<BR>
																								<asp:imagebutton id="LPaneDelete" runat="server" ImageUrl="../images/delete.gif"></asp:imagebutton></TD>
																						</TR>
																					</TABLE>
																				</FONT>
																			</TD>
																			...
																			<TD style="WIDTH: 4px" vAlign="bottom"><FONT face="新細明體">
																					<TABLE id="Table7" cellSpacing="0" cellPadding="0" width="100%" border="0">
																						...
																						<TR>
																							<TD><BR>
																								<asp:imagebutton id="CPaneUpdate" runat="server" ImageUrl="../images/edit.gif"></asp:imagebutton><BR>
																								<BR>
																								<asp:imagebutton id="CPaneDelete" runat="server" ImageUrl="../images/delete.gif"></asp:imagebutton></TD>
																						</TR>
																					</TABLE>
																				</FONT>
																			</TD>
																			...
																			<TD vAlign="bottom"><FONT face="新細明體">
																					<TABLE id="Table8" cellSpacing="0" cellPadding="0" width="100%" border="0">
																						...
																						<TR>
																							<TD><BR>
																								<asp:imagebutton id="RPaneUpdate" runat="server" ImageUrl="../images/edit.gif"></asp:imagebutton><BR>
																								<BR>
																								<asp:imagebutton id="RPaneDelete" runat="server" ImageUrl="../images/delete.gif"></asp:imagebutton></TD>
																						</TR>
																					</TABLE>
																				</FONT>
																			</TD>
