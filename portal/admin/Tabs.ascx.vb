...
#End Region
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            For Each tab In _portalSettings.DesktopTabs
                ...
                t.TabId = tab.TabId
                't.TabId = CType(tab.AuthorizedRoles, Integer)
        ...
        Private Sub UpDown_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs) Handles downBtn.Click, upBtn.Click
            ...
            If tabList.SelectedIndex <> -1 Then
                ...
                Response.Redirect(("~/DesktopDefault.aspx?tabindex=" & (portalTabs.Count - 1).ToString() & "&tabid=" & tabId & "&sid=" & CType(Session("sid"), String)))
        ...
        Private Sub DeleteBtn_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs) Handles deleteBtn.Click
            ...
            If tabList.SelectedIndex <> -1 Then
                ...
                config.DeleteTab(t.TabId, CType(Session("sid"), String))
                ...
                ' Redirect to this site to refresh
                Response.Redirect(("~/DesktopDefault.aspx?tabindex=" & tabIndex & "&tabid=" & tabId & "&sid=" & CType(Session("sid"), String)))
        ...
        Private Sub AddTab_Click(ByVal Sender As Object, ByVal e As EventArgs) Handles addBtn.Click
			...
			Dim config As New Configuration()
            t.TabId = config.AddTab(_portalSettings.PortalId, t.TabName, t.TabOrder, CType(Session("sid"), String))

			' reload the _portalSettings from the database
            HttpContext.Current.Items("PortalSettings") = New PortalSettings(_portalSettings.PortalId, t.TabId, CType(Session("sid"), String))

			' Reset the order numbers for the tabs within the list
			OrderTabs()

            ' Redirect to edit page
            Response.Redirect(("~/Admin/TabLayout.aspx?tabid=" & t.TabId & "&sid=" & CType(Session("sid"), String)))
        ...
        Private Sub EditBtn_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs) Handles editBtn.Click
            ...
            If tabList.SelectedIndex <> -1 Then
                ...
                Response.Redirect(("~/Admin/TabLayout.aspx?tabid=" & t.TabId & "&ttabid=" & CType(TtabId, String) & "&sid=" & CType(Session("sid"), String)))
        ...
        Sub OrderTabs()
            ...
            For Each t In portalTabs
				...
				Dim config As New Configuration()
                config.UpdateTabOrder(t.TabId, t.TabOrder, CType(Session("sid"), String))
