Imports System.IO
Public Class EditWebFormSetting
...
#Region " Web Form 設計工具產生的程式碼 "
    ...
    Protected WithEvents LPaneUpdate As System.Web.UI.WebControls.ImageButton
    Protected WithEvents LPaneDelete As System.Web.UI.WebControls.ImageButton
    Protected WithEvents CPaneDelete As System.Web.UI.WebControls.ImageButton
    Protected WithEvents CPaneUpdate As System.Web.UI.WebControls.ImageButton
    ...
    Protected WithEvents RPaneDelete As System.Web.UI.WebControls.ImageButton
    Protected WithEvents RPaneUpdate As System.Web.UI.WebControls.ImageButton
...
#End Region
    ...
    Private Sub ShowTree()
        Dim fls() As String = Directory.GetFiles(Server.MapPath("/Portalfiles/xml/WebForm"), "D" & sid & "_*.xml")
        Dim treeFile1 As String

        If UBound(fls) < 1 Then
            WriteXmlTree()
            fls = Directory.GetFiles(Server.MapPath("/Portalfiles/xml/WebForm"), "D" & sid & "_*.xml")
        End If
    ...
    Private Sub WriteXmlTree()
        ...
        xmlDoc.Save(Server.MapPath("/PortalFiles/xml/WebForm/" & TreefileTemp))
