<%@ Control Inherits="ASPNET.StarterKit.Portal.AllWebFormSetting" CodeBehind="AllWebFormSetting.ascx.vb" language="vb" AutoEventWireup="false" %>
<%@ Register TagPrefix="uc1" TagName="DesktopModuleTitle" Src="../DesktopModuleTitle.ascx" %>
<table width="98%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td colspan="3">
			<uc1:DesktopModuleTitle id="DesktopModuleTitle1" editurl="~/admin/EditAllWebFormSetting.aspx" runat="server"></uc1:DesktopModuleTitle>
		</td>
	</tr>
	<tr>
			...
			<TABLE border="0">
				<TR>
					<TD valign="top" align="center">
						<!---------------------------------------------------------------------------------------------------------------------->
						<asp:Label id="Label1" runat="server" CssClass="normal">維護網站的各項模組與顯示內容</asp:Label>
						<!---------------------------------------------------------------------------------------------------------------------->
					</TD>
				</TR>
			</TABLE>
