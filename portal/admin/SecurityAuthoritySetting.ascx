<%@ Control Inherits="ASPNET.StarterKit.Portal.SecurityAuthoritySetting" CodeBehind="SecurityAuthoritySetting.ascx.vb" language="vb" AutoEventWireup="false" %>
<%@ Register TagPrefix="uc1" TagName="DesktopModuleTitle" Src="../DesktopModuleTitle.ascx" %>
<table width="98%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td colspan="3">
			<uc1:DesktopModuleTitle id="DesktopModuleTitle1" editurl="~/admin/EditSecurityAuthority.aspx" runat="server"></uc1:DesktopModuleTitle>
		</td>
	</tr>
	<tr>
