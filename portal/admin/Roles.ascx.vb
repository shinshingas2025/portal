...
#End Region
        ...
        Private Sub AddRole_Click(ByVal Sender As Object, ByVal e As EventArgs) Handles AddRoleBtn.Click
            ...
            roles.AddRole(_portalSettings.PortalId, "New Role", CType(Session("sid"), String))
                ...
                Else
                    ...
                    Else
                        ...
                        If e.CommandName = "members" Then
                            ...
                            Response.Redirect(("~/Admin/SecurityRoles.aspx?sid=" & CType(Session("sid"), String) & "&roleId=" & roleId & "&rolename=" & _roleName & "&tabindex=" & tabIndex & "&tabid=" & tabId))
        ...
        Sub BindData()
			...
			rolesList.DataSource = roles.GetPortalRoles(_portalSettings.PortalId)
            rolesList.DataBind()
