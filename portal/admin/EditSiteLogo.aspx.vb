...
#End Region
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If Page.IsPostBack = False Then
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    Image1.ImageUrl = "/PortalFiles/UpLoadFiles/schoollogo/" & CType(dt.Rows(0).Item("imagelogo"), String)

                    lblFileName.Text = CType(dt.Rows(0).Item("imagelogo"), String)
                Else
        ...
        Private Sub updateButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles updateButton.Click
            ...
            objSiteDB.UpdateSiteLogo(CType(Session("sid"), String), lblFileName.Text.Trim)
        ...
        Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
            ...
            FileName = PhotoUpload(CType(file1.PostedFile, HttpPostedFile), getUploadFileName, "/PortalFiles/UpLoadFiles/schoollogo")
            If FileName <> "" Then
                Me.Image1.ImageUrl = "/PortalFiles/UpLoadFiles/schoollogo/" & FileName
