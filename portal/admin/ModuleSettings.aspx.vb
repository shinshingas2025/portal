...
#End Region
        ...
        Private Sub ApplyChanges_Click(ByVal Sender As Object, ByVal e As EventArgs) Handles ApplyButton.Click
            ...
            If Not (value Is Nothing) Then
                ...
                config.UpdateModule(moduleId, m.ModuleOrder, m.PaneName, moduleTitle.Text, Int32.Parse(cacheTime.Text), editRoles, showMobile.Checked, CType(Session("sid"), String))
            ...
            Response.Redirect(("TabLayout.aspx?tabid=" & tabId & "&sid=" & CType(Session("sid"), String)))
