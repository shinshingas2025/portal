...
#End Region
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If Not (Request.Params("ttabid") Is Nothing) Then
                ttabid = Int32.Parse(Request.Params("ttabid"))
            End If
        ...
        Private Sub AddModuleToPane_Click(ByVal sender As Object, ByVal e As EventArgs) Handles AddModuleBtn.Click
            ...
            m.ModuleId = config.AddModule(tabId, m.ModuleOrder, "1-ContentPane", m.ModuleTitle, m.ModuleDefId, 0, CType(ttabid, String), False, CType(Session("sid"), String))
            'Update for 
            Dim objSiteDB As New SiteDB
            m.ModuleId = objSiteDB.AddModule(tabId, m.ModuleOrder, "1-ContentPane", m.ModuleTitle, m.ModuleDefId, 0, CType(ttabid, String), False, CType(Session("sid"), String))
            objSiteDB = Nothing
            ...
            HttpContext.Current.Items("PortalSettings") = New PortalSettings(_portalSettings.PortalId, tabId, CType(Session("sid"), String))
            ...
            For Each item In modules
                config.UpdateModuleOrder(item.ModuleId, item.ModuleOrder, "ContentPane", CType(Session("sid"), String))
            Next item
        ...
        Private Sub UpDown_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs) Handles LeftDownBtn.Click, LeftUpBtn.Click, ContentDownBtn.Click, ContentUpBtn.Click, RightDownBtn.Click, RightUpBtn.Click
            ...
            If _listbox.SelectedIndex <> -1 Then
                ...
                Dim item As ModuleItem
                For Each item In modules
                    config.UpdateModuleOrder(item.ModuleId, item.ModuleOrder, pane, CType(Session("sid"), String))
                Next item
        ...
        Private Sub RightLeft_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs) Handles LeftRightBtn.Click, ContentLeftBtn.Click, ContentRightBtn.Click, RightLeftBtn.Click
            ...
            If sourceBox.SelectedIndex <> -1 Then
				...
				Dim config As New Configuration()
                config.UpdateModuleOrder(m.ModuleId, 998, targetPane, CType(Session("sid"), String))
                ...
                For Each item In sourceList
                    config.UpdateModuleOrder(item.ModuleId, item.ModuleOrder, sourcePane, CType(Session("sid"), String))
                Next item
                ...
                For Each item In targetList
                    config.UpdateModuleOrder(item.ModuleId, item.ModuleOrder, targetPane, CType(Session("sid"), String))
                Next item
        ...
        Private Sub Apply_Click(ByVal Sender As Object, ByVal e As EventArgs) Handles applyBtn.Click
            ...
            Response.Redirect(("~/DesktopDefault.aspx?tabindex=" & adminIndex.ToString() & "&tabid=" & CType(_portalSettings.DesktopTabs(adminIndex), TabStripDetails).TabId) & "&sid=" & CType(Session("sid"), String))
        ...
        Sub SaveTabData()
			...
			Dim config As New Configuration()
            config.UpdateTab(_portalSettings.PortalId, tabId, tabName.Text, _portalSettings.ActiveTab.TabOrder, authorizedRoles, mobileTabName.Text, showMobile.Checked, CType(Session("sid"), String))
        ...
        Private Sub EditBtn_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs) Handles LeftEditBtn.Click, ContentEditBtn.Click, RightEditBtn.Click
            ...
            If _listbox.SelectedIndex <> -1 Then
                ...
                Response.Redirect(("ModuleSettings.aspx?mid=" & mid & "&tabid=" & tabId & "&sid=" & CType(Session("sid"), String)))
        ...
        Private Sub DeleteBtn_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs) Handles LeftDeleteBtn.Click, ContentDeleteBtn.Click, RightDeleteBtn.Click
            ...
            If _listbox.SelectedIndex <> -1 Then
                ...
                If m.ModuleId > -1 Then
                    ...
                    config.DeleteModule(m.ModuleId, CType(Session("sid"), String))
        ...
        Sub BindData()
            ...
            Dim rolesObj As New RolesDB
            Dim roles As SqlDataReader = rolesObj.GetPortalRoles(_portalSettings.PortalId)
            ...
            Dim config As New Configuration
            moduleType.DataSource = config.GetModuleDefinitions(_portalSettings.PortalId)
            moduleType.DataBind()
