...
#End Region
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If Page.IsPostBack = False Then
                ...
                Else
                    ...
                    Dim modDefRow As SiteConfiguration.ModuleDefinitionRow = config.GetSingleModuleDefinition(defId)
        ...
        Private Sub UpdateBtn_Click(ByVal sender As Object, ByVal e As EventArgs) Handles updateButton.Click
            ...
            If Page.IsValid = True Then
                ...
                If defId = -1 Then
                    ...
                    ' config.AddModuleDefinition(_portalSettings.PortalId, FriendlyName.Text, DesktopSrc.Text, MobileSrc.Text, CType(Session("sid"), String))

                    objDefModule.AddDefModule(FriendlyName.Text, DesktopSrc.Text, MobileSrc.Text)

                Else

                    ' update the module definition
                    ' config.UpdateModuleDefinition(defId, FriendlyName.Text, DesktopSrc.Text, MobileSrc.Text, CType(Session("sid"), String))

                    objDefModule.UpdateDefModule(defId, FriendlyName.Text, DesktopSrc.Text, MobileSrc.Text)

                End If

                objDefModule = Nothing
        ...
        Private Sub DeleteBtn_Click(ByVal sender As Object, ByVal e As EventArgs) Handles deleteButton.Click
            ...
            ' delete definition
			Dim config As New Configuration()
            ' config.DeleteModuleDefinition(defId, CType(Session("sid"), String))
            Dim objDefModule As New Portal_DefModuleDB
            objDefModule.DeleteDefModule(defId)
            objDefModule = Nothing
            ' Redirect back to the portal admin page
            Response.Redirect(("~/DesktopDefault.aspx?tabindex=" & tabIndex & "&tabid=" & tabId & "&sid=" & CType(Session("sid"), String)))
