...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="BulletinList.aspx.vb" Inherits="ASPNET.StarterKit.Portal.BulletinList" %>
													...
													<asp:datalist id="DataList1" runat="server" DataKeyField="EntityID" Width="100%" OnItemCommand="ShowBulletin">
														<ItemTemplate>
															<TABLE cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
																<TR ><td width="10" valign=top><Img src='/PortalFiles/WebImage/<%=Request.Params("sid")%>/<%=Request.Params("sid")%>_0007.gif' alt='項目'></td>
