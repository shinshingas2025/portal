        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If Page.IsPostBack = False Then
                ...
                If itemId <> 0 Then
                    ...
                    Dim dr As SqlDataReader = events.GetSingleEvent(itemId)
        ...
        Private Sub UpdateBtn_Click(ByVal sender As Object, ByVal e As EventArgs) Handles updateButton.Click
            ...
            If Page.IsValid = True Then
                ...
                If itemId = 0 Then
                    ...
                    events.AddEvent(moduleId, itemId, Context.User.Identity.Name, TitleField.Text, DateTime.Parse(ExpireField.Text), DescriptionField.Text, WhereWhenField.Text, CType(Session("sid"), String))
