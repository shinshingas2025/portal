...
#End Region
            ...
            If Page.IsPostBack = False Then
                ...
                If moduleId > 0 Then
                    ...
                    If dt.Rows.Count > 0 Then
                        Src.Text = CType(dt.Rows(0).Item("url"), String)
                        Width.Text = CType(dt.Rows(0).Item("framewidth"), String)
                        Height.Text = CType(dt.Rows(0).Item("frameheight"), String)
                    End If
                    objIframe = Nothing
                End If
        ...
        ' ASPNET.StarterKit.PortalAdminDB() data component to encapsulate the data
        ...
        Private Sub UpdateBtn_Click(ByVal sender As Object, ByVal e As EventArgs) Handles updateButton.Click
            ...
            Dim objIframe As New Portal_iframe
            If objIframe.Getiframe(moduleId).Tables(0).Rows.Count > 0 Then
                objIframe.Updateiframe(moduleId, Src.Text, CType(Width.Text, Integer), CType(Height.Text, Integer))
            Else
                objIframe.ADDiframe(CType(Session("sid"), String), moduleId, Src.Text, CType(Width.Text, Integer), CType(Height.Text, Integer))
            End If
