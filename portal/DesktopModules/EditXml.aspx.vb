...
#End Region
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If Page.IsPostBack = False Then
                ...
                If moduleId > 0 Then
                    ...
                    Dim settings As Hashtable = Configuration.GetModuleSettings(moduleId)
        ...
        Private Sub UpdateBtn_Click(ByVal sender As Object, ByVal e As EventArgs) Handles updateButton.Click
            ...
            config.UpdateModuleSetting(moduleId, "xmlsrc", XmlDataSrc.Text, CType(Session("sid"), String))
            config.UpdateModuleSetting(moduleId, "xslsrc", XslTransformSrc.Text, CType(Session("sid"), String))
