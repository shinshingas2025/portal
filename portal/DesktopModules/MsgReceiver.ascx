...
<%@ Control language="vb" Inherits="ASPNET.StarterKit.Portal.MsgReceiver" CodeBehind="MsgReceiver.ascx.vb" AutoEventWireup="false" %>
<table width="98%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td colspan="3">
			<ASPNETPORTAL:TITLE id="Title1" runat="server" EditUrl="~/DesktopModules/MsgReceiver/none.aspx" EditText="管理資料"
