...
<%@ Control language="vb" Inherits="ASPNET.StarterKit.Portal.RequestJob" CodeBehind="RequestJob.ascx.vb" AutoEventWireup="false" %>
<table width="98%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td colspan="3">
			<aspnetportal:title editurl="~/DesktopModules/EditIFrame.aspx" edittext="編輯" runat="server" id="Title2" />
		</td>
	</tr>
	<tr>
			...
			<TABLE border="0">
				<TR>
					<TD valign="top" align="center">
						<!---------------------------------------------------------------------------------------------------------------------->
						<iframe id="Iframe1" frameBorder="0" width="100%" height="400" runat="server"></iframe>
						<!---------------------------------------------------------------------------------------------------------------------->
					</TD>
				</TR>
			</TABLE>
