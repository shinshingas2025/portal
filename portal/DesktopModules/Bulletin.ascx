...
<%@ Control language="vb" Inherits="ASPNET.StarterKit.Portal.Bulletin" CodeBehind="Bulletin.ascx.vb" AutoEventWireup="false" %>
			...
			<TABLE border="0" width="100%">
				<TR>
					<TD valign="top" align="center">
												...
												<table width="100%" cellpadding="0" cellspacing="0" border="0">
													<tr>
														...
														<td  class=normal valign=top>
															<a href='DesktopModules/Bulletin/BulletinShow.aspx?sid=<%=Request.Params("sid")%>&mid=<%=ModuleId%>&tabid=<%=tabid%>&tabindex=<%=tabindex%>&bulletinmapid=<%# DataBinder.Eval(Container.DataItem,"EntityID") %>'>
						...
						<P align="right">
							<uc1:DesktopModuleBottom id="DesktopModuleBottom2" runat="server" EditText="more" EditUrl="~/DesktopModules/Bulletin/BulletinList.aspx"></uc1:DesktopModuleBottom>
							<br>
						</P>
						<!---------------------------------------------------------------------------------------------------------------------->
					</TD>
