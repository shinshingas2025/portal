...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="EPaperEdit.aspx.vb" Inherits="ASPNET.StarterKit.Portal.EPaperEdit" validateRequest="false" %>
								...
								<TR>
									<TD vAlign="top" align="center">
										...
										<TABLE id="Table1" height="281" cellSpacing="0" cellPadding="0" width="100%" align="center"
											...
											<TR>
												<TD class="SubHead"><FONT face="新細明體">電子報標題</FONT></TD>
												<TD><asp:textbox id="TextBoxTitle" runat="server"></asp:textbox></TD>
											</TR>
											<TR>
												<TD class="SubHead"><FONT face="新細明體">電子報描述</FONT></TD>
												<TD><FONT face="新細明體"><asp:textbox id="TextBoxDescription" runat="server" Columns="80"></asp:textbox></FONT></TD>
											</TR>
											<tr>
												<td>電子報本文</td>
												<td>
													<textarea id="ContentFile" name="ContentFile" cols="70" rows="20">&lt;%=myContentFile%&gt;</textarea>
												</td>
											</tr>
											<tr>
