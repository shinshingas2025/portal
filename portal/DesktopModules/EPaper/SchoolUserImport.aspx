...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SchoolUserImport.aspx.vb" Inherits="ASPNET.StarterKit.Portal.SchoolUserImport" %>
...
topMargin=0 rightMargin=0 marginheight="0" marginwidth="0">
		<form id="Form1" method="post" runat="server">
          ...
          ><asp:label id="Label7" runat="server" CssClass="itemtitle">學校使用者名單匯入</asp:label></td>
										...
										<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
												...
												<td align="center" colSpan="4">
													<table cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
														...
														<TR>
															...
															<TD></TD>
															<TD></TD>
															<TD><asp:button id="ButtonQuery" runat="server" Text="搜尋"></asp:button></TD>
														</TR>
													</table>
													<HR width="100%" SIZE="1">
												</td>
											...
											<tr>
												<td align="center" colSpan="4">
													<table cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
														<tr>
															<td width="5%"><asp:linkbutton id="LinkButtonImportUserTenPageUp" runat="server" CssClass="normal">上十頁</asp:linkbutton></td>
															<td width="5%"><asp:linkbutton id="LinkButtonImportUserPageUp" runat="server" CssClass="normal">上一頁</asp:linkbutton></td>
															<td align="center" width="80%"><asp:placeholder id="PlaceHolderImportUserPageIndex" runat="server"></asp:placeholder></td>
															<td width="5%"><asp:linkbutton id="LinkButtonImportUserPageDown" runat="server" CssClass="normal">下一頁</asp:linkbutton></td>
															<td width="5%"><asp:linkbutton id="LinkButtonImportUserTenPageDown" runat="server" CssClass="normal">下十頁</asp:linkbutton></td>
														</tr>
													</table>
												</td>
											</tr>
											<tr>
												<td align="center" colSpan="4">
													<asp:button id="ButtonImportUser" runat="server" Text="匯入"></asp:button>
