...
#End Region
		...
		Private Sub SaveForm()
			...
			'create new epaper
			'audit
			myAuditID = AuditDAO.InsertEntity(sid, moduleId, 0, LevelType.info, ActionType.insert, Me.ToString, myEPaperDAO.ToString, "InsertEntity", myFileName, "", Context.User.Identity.Name, Now)
			'log before action
			'none
			'actual action
			myEPaperID = myEPaperDAO.InsertEntity(sid, moduleId, 0, myTitle, myDescription, "", "", "", Now, Now, user, Now)
			'log after action
