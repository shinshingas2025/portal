...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="SubscriptionListImport.aspx.vb" Inherits="ASPNET.StarterKit.Portal.SubscriptionListImport" %>
											...
											<tr>
												<td align="center" colSpan="3">
													<table cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
														<tr>
															<td width="79"><asp:label id="Label1" runat="server" CssClass="subhead">上傳檔案</asp:label></td>
															<td><input id="UploadFileName" type="file" name="UploadFileName" runat="server"></td>
														</tr>
													</table>
												</td>
											</tr>
											<tr>
												<td align="center" colSpan="3"><asp:button id="ButtonOK" runat="server" Text="確定"></asp:button><asp:button id="ButtonImportSchoolUser" runat="server" Text="學校使用者名單匯入"></asp:button><asp:button id="ButtonCancel" runat="server" Text="取消"></asp:button>
													<asp:Button id="ButtonReturn" runat="server" Text="返回"></asp:Button></td>
											</tr>
											<tr>
												<td align="center"><asp:label id="LabelLog" runat="server">Log</asp:label><br>
													<asp:textbox id="TextBoxLog" runat="server" Rows="10" Columns="100" TextMode="MultiLine"></asp:textbox></td>
											</tr>
										</TABLE>
										<!----------------------------------------------------------------------------------------------------------------------></TD>
								</TR>
