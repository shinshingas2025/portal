...
#End Region
        ...
        Private Sub UpdateBtn_Click(ByVal sender As Object, ByVal e As EventArgs) Handles updateButton.Click
            ...
            itemId = discuss.AddMessage(moduleId, itemId, User.Identity.Name, Server.HtmlEncode(TitleField.Text), Server.HtmlEncode(BodyField.Text), CType(Session("sid"), String))
        ...
        Sub BindData()
            ...
            TitleField.Text = ReTitle(Server.HtmlDecode(Title.Text))
        ...
        Function ReTitle(ByVal title As String) As String
            ...
            If title.Length > 0 And title.IndexOf("回覆: ", 0) = -1 Then
                title = "回覆: " & title
            End If
