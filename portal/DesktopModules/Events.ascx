...
<table width="98%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td colspan="3">
			<ASPNETPortal:title EditText="新增資料" EditUrl="~/DesktopModules/EditEvents.aspx" runat="server" id="Title1" />
		</td>
	</tr>
	<tr>
									...
									<asp:DataList id="myDataList" CellPadding="4" Width="100%" EnableViewState="false" runat="server">
										<ItemTemplate>
											<span class="ItemTitle">
												<asp:HyperLink id="editLink" ImageUrl="~/images/edit.gif" NavigateUrl='<%# "~/DesktopModules/EditEvents.aspx?ItemID=" & DataBinder.Eval(Container.DataItem,"ItemID") & "&mid=" & ModuleId & "&sid=" & ctype(session("sid"),string) %>' Visible="<%# IsEditable %>" runat="server" />
