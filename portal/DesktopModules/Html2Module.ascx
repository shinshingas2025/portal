<%@ Control language="vb" Inherits="ASPNET.StarterKit.Portal.Html2Module" CodeBehind="Html2Module.ascx.vb" AutoEventWireup="false" %>
<%@ Register TagPrefix="uc1" TagName="DesktopModuleBottom" Src="../DesktopModuleBottom.ascx" %>
<%@ Register TagPrefix="ASPNETPortal" TagName="Title" Src="~/DesktopModuleTitle.ascx"%>
<table width="98%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td colspan="3">
			<ASPNETPortal:title EditUrl="~/DesktopModules/EditHtml2.aspx" runat="server" id="Title1" />
		</td>
	</tr>
	<tr>
			...
			<TABLE border="0">
				<TR>
					<TD valign="top" align="center">
						...
						<!---------------------------------------------------------------------------------------------------------------------->
						<uc1:DesktopModuleBottom id="DesktopModuleBottom1" runat="server" EditUrl="~/DesktopModules/DetailHtml2.aspx"></uc1:DesktopModuleBottom>
					</TD>
				</TR>
			</TABLE>
		</td>
