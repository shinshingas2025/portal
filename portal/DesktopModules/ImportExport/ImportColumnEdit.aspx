...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ImportColumnEdit.aspx.vb" Inherits="ASPNET.StarterKit.Portal.ImportColumnEdit" %>
...
topMargin=0 rightMargin=0 marginheight="0" marginwidth="0">
		<form id="Form1" method="post" runat="server">
          ...
          ><asp:label id="Label7" runat="server" CssClass="itemtitle">匯入欄位修改</asp:label></td>
