...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ImportUser.aspx.vb" Inherits="ASPNET.StarterKit.Portal.ImportUser" %>
								...
								<TR>
									<TD vAlign="top" align="center">
										...
										<TABLE class="TTable1" id="Table1" cellSpacing="3" cellPadding="3" width="100%" align="center"
												...
												<td align="center" colSpan="3">
													<table cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
														<tr>
															...
															<td><input id="UploadFileName" type="file" runat="server"></td>
														</tr>
													</table>
												</td>
											</tr>
											...
											<tr>
												<td align="center">
													<asp:Label id="LabelLog" runat="server">Log</asp:Label><br>
													<asp:TextBox id="TextBoxLog" runat="server" TextMode="MultiLine" Columns="100" Rows="10"></asp:TextBox>
												</td>
											</tr>
										</TABLE>
										<!----------------------------------------------------------------------------------------------------------------------></TD>
