...
#End Region
        ...
        Private Sub UpdateBtn_Click(ByVal sender As Object, ByVal e As EventArgs) Handles updateButton.Click
            ...
            config.UpdateModuleSetting(moduleId, "src", Src.Text, CType(Session("sid"), String))
            config.UpdateModuleSetting(moduleId, "height", Height.Text, CType(Session("sid"), String))
            config.UpdateModuleSetting(moduleId, "width", Width.Text, CType(Session("sid"), String))
