...
<%@ Page language="vb" CodeBehind="GuestBookAdminList.aspx.vb" AutoEventWireup="false" Inherits="ASPNET.StarterKit.Portal.GuestBookAdminList" %>
<HTML>
	<HEAD>
		<link 
...
topMargin=0 rightMargin=0 marginheight="0" marginwidth="0">
		<form id="Form1" runat="server">
			...
			<table cellSpacing="0" cellPadding="0" width="80%" border="0" align="center">
				<tr vAlign="top">
					<td colSpan="3"><table cellSpacing="0" cellPadding="0" width="98%" align="right" border="0">
							<tr>
					...
					<td width="100%" align="center" bgcolor="#ffffff">
						<asp:datagrid id="myDataGrid" runat="server" AutoGenerateColumns="False" OnPageIndexChanged="PageChanged"
							...
							<Columns>
											...
											<tr>
												<td bgcolor="#ffffff" width="100%">
													<table border="0" cellSpacing="0" cellPadding="0" width="100%">
														...
														<tr>
															<td colspan="4">
																<asp:Label Runat="server" ID="Label3" NAME="Label1" CssClass="normal">
								...
								<asp:ButtonColumn Text="回覆" CommandName="Select" ItemStyle-Font-Size="10"></asp:ButtonColumn>
								<asp:HyperLinkColumn Text="閱覽" DataNavigateUrlField="EntityID" DataNavigateUrlFormatString="~/DesktopModules/GuestBook/GuestBookView.aspx?EntityID={0}"
									ItemStyle-Font-Size="10"></asp:HyperLinkColumn>
							</Columns>
