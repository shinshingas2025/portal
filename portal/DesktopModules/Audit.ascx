...
<%@ Control language="vb" Inherits="ASPNET.StarterKit.Portal.Audit" CodeBehind="Audit.ascx.vb" AutoEventWireup="false" %>
<table width="98%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td colspan="3">
			<ASPNETPORTAL:TITLE id="Title1" runat="server" EditUrl="~/DesktopModules/Audit/AuditList.aspx" EditText="管理資料" EditShow="false"></ASPNETPORTAL:TITLE>
		</td>
	</tr>
	<tr>
				...
				<TR>
					<TD valign="top" align="center">
						...
						<TABLE class="TTable1" id="Table1" cellSpacing="0" cellPadding="0" width="100%" border="0">
							<TR>
								<td align="center" width="100%"><a href='DesktopModules/Audit/AuditList.aspx?sid=<%=Request.Params("sid")%>&mid=<%=ModuleId%>&tabid=<%=tabid%>&tabindex=<%=tabindex%>'><img src="images/ZA_Mark.gif" width="150" height="120" border="0" alt="稽核資料" /></a></td>
							</TR>
						</TABLE>
						<!---------------------------------------------------------------------------------------------------------------------->
					</TD>
