...
#End Region
        ...
        '
        ' It then uses the ASPNET.StarterKit.PortalAnnouncementsDB() data component
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If Page.IsPostBack = False Then
                Me.ExpireField.Text = CType(Now.Year, String) & "/12/31"
                If itemId <> 0 Then

                    ' Obtain a single row of announcement information
                    Dim announcementDB As New ASPNET.StarterKit.Portal.AnnouncementsDB
        ...
        ' create or update an announcement.  It  uses the ASPNET.StarterKit.PortalAnnouncementsDB()
        ...
        Private Sub UpdateBtn_Click(ByVal sender As Object, ByVal e As EventArgs) Handles updateButton.Click
            ...
            If Page.IsValid = True Then
                ...
                If itemId = 0 Then
                    ...
                    'announcementDB.AddAnnouncement(moduleId, itemId, Context.User.Identity.Name, TitleField.Text, DateTime.Parse(ExpireField.Text), DescriptionField.Text, MoreLinkField.Text, MobileMoreField.Text, CType(Session("sid"), String))
                    announcementDB.AddAnnouncement(moduleId, itemId, Context.User.Identity.Name, TitleField.Text, DateTime.Parse(ExpireField.Text), DescriptionField.Text, "", "", CType(Session("sid"), String))
                ...
                Else
                    ...
                    announcementDB.UpdateAnnouncement(moduleId, itemId, Context.User.Identity.Name, TitleField.Text, DateTime.Parse(ExpireField.Text), DescriptionField.Text, "", "")
                End If
        ...
        ' an announcement.  It  uses the ASPNET.StarterKit.PortalAnnouncementsDB()
        ' data component to encapsulate all data functionality.
        '
        '****************************************************************
