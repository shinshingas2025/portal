...
<%@ Control language="vb" Inherits="ASPNET.StarterKit.Portal.PrivateAnnouncement" CodeBehind="PrivateAnnouncement.ascx.vb" AutoEventWireup="false" %>
<table width="98%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td colspan="3">
			<ASPNETPortal:title EditText="編輯" EditUrl="~/DesktopModules/EditPrivateAnnouncement.aspx" runat="server" id="Title1" />
		</td>
	</tr>
	<tr>
