...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CouncilmanInstructionAdminFrame.aspx.vb" Inherits="ASPNET.StarterKit.Portal.AuditSystem.Module.CouncilmanInstructionAdminFrame" %>
										...
										<tr>
											...
											<td align="left" width="20%">
												<table width="100%">
													...
													<tr>
														<td align="center" colspan="2">
															<asp:button id="ButtonInstructionInsert" runat="server" CssClass="nav" Text="新增"></asp:button>
															<asp:button id="ButtonInstructionUpdate" runat="server" CssClass="nav" Text="修改"></asp:button>
															<asp:button id="ButtonInstructionDelete" runat="server" CssClass="nav" Text="刪除"></asp:button>
														</td>
													</tr>
												</table>
											</td>
