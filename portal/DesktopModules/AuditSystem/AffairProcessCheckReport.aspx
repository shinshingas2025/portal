...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="AffairProcessCheckReport.aspx.vb" Inherits="ASPNET.StarterKit.Portal.AuditSystem.Module.AffairProcessCheckReport" %>
...
topMargin=0 rightMargin=0 marginwidth="0" marginheight="0">
		<form id="Form1" method="post" runat="server">
          ...
          ><asp:label id="Label7" runat="server" CssClass="itemtitle">各組重要業務報告表</asp:label></td>
