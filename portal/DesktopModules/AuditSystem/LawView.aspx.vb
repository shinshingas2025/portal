			...
			If lawID.Trim.Length > 0 Then
				...
				If myLawDataSet.Tables(0).Rows.Count = 1 Then
					...
					If myLawDataSet.Tables(0).Rows.Count > 0 Then
						...
						Next
						If bFound = True Then
							Response.Redirect("~/DesktopModules/AuditSystem/LawView.aspx?sid=" & sid & "&mid=" & moduleId & "&tabid=" & tabId & "&tabindex=" & tabIndex & "&parentID=" & parentID & "&lawID=" & myPreviousID)
						End If
					End If
				Else
				...
				If myLawDataSet.Tables(0).Rows.Count = 1 Then
					...
					If myLawDataSet.Tables(0).Rows.Count > 0 Then
						...
						If bFound = True Then
							...
							End If
							Response.Redirect("~/DesktopModules/AuditSystem/LawView.aspx?sid=" & sid & "&mid=" & moduleId & "&tabid=" & tabId & "&tabindex=" & tabIndex & "&parentID=" & parentID & "&lawID=" & myNextID)
						End If
					End If
				Else
					'exception:record is empty or duplicated
			...
			If lawID.Trim.Length > 0 Then
				...
				If myLawDataSet.Tables(0).Rows.Count = 1 Then
					...
					Else
						...
						myParentID = "0"
					End If
					Response.Redirect("~/DesktopModules/AuditSystem/LawView.aspx?sid=" & sid & "&mid=" & moduleId & "&tabid=" & tabId & "&tabindex=" & tabIndex & "&parentID=" & myParentID & "&lawID=" & myPreviousID)
				Else
					'exception:record is empty or duplicated
				End If
			Else
			...
			If lawID.Trim.Length > 0 Then
				...
				If myLawDataSet.Tables(0).Rows.Count = 1 Then
					...
					If myLawDataSet.Tables(0).Rows.Count = 1 Then
						...
						myParentID = CType(myLawDataSet.Tables(0).Rows(0).Item("ParentID"), String)
					End If
					Response.Redirect("~/DesktopModules/AuditSystem/LawView.aspx?sid=" & sid & "&mid=" & moduleId & "&tabid=" & tabId & "&tabindex=" & tabIndex & "&parentID=" & myParentID & "&lawID=" & myNextID)
				Else
					'exception:record is empty or duplicated
				End If
			Else
