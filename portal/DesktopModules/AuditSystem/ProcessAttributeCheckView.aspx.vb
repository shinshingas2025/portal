...
Namespace ASPNET.StarterKit.Portal.AuditSystem.Module
	...
	Public Class ProcessAttributeCheckView
			...
			If processID.Trim.Length > 0 Then
				...
				If myProcessDataSet.Tables(0).Rows.Count = 1 Then
					...
					If myProcessDataSet.Tables(0).Rows.Count > 0 Then
						...
						Next
						If bFound = True Then
							Response.Redirect("~/DesktopModules/AuditSystem/ProcessAttributeCheckView.aspx?sid=" & sid & "&mid=" & moduleId & "&tabid=" & tabId & "&tabindex=" & tabIndex & "&processID=" & myPreviousID)
						End If
					End If
				Else
				...
				If myProcessDataSet.Tables(0).Rows.Count = 1 Then
					...
					If myProcessDataSet.Tables(0).Rows.Count > 0 Then
						...
						If bFound = True Then
							...
							End If
							Response.Redirect("~/DesktopModules/AuditSystem/ProcessAttributeCheckView.aspx?sid=" & sid & "&mid=" & moduleId & "&tabid=" & tabId & "&tabindex=" & tabIndex & "&processID=" & myNextID)
						End If
					End If
				Else
					'exception:form record is empty or duplicated
