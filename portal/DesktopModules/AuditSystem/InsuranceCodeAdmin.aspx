...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="InsuranceCodeAdmin.aspx.vb" Inherits="ASPNET.StarterKit.Portal.AuditSystem.Module.InsuranceCodeAdmin" %>
...
topMargin=0 rightMargin=0 marginheight="0" marginwidth="0">
		<form id="Form1" method="post" runat="server">
          ...
          ><asp:label id="Label7" runat="server" CssClass="itemtitle">保險代碼管理</asp:label></td>
