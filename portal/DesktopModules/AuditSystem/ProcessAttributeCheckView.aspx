...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ProcessAttributeCheckView.aspx.vb" Inherits="ASPNET.StarterKit.Portal.AuditSystem.Module.ProcessAttributeCheckView" %>
...
topMargin=0 rightMargin=0 marginwidth="0" marginheight="0">
		<form id="Form1" method="post" encType="multipart/form-data" runat="server">
          ...
          ><asp:label id="Label7" runat="server" CssClass="itemtitle">處理情形</asp:label></td>
												...
												<td align="center">
													<table width="100%">
														<tr>
															...
															<td class="promo"><asp:Label id="LabelProcessDate" runat="server"></asp:Label></td>
														</tr>
														<tr>
															<td class="promoHeader">處理情形</td>
															<td class="promo"><asp:Label id="LabelProcessState" runat="server"></asp:Label></td>
														</tr>
														<tr>
