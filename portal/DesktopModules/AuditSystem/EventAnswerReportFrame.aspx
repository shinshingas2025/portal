...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="EventAnswerReportFrame.aspx.vb" Inherits="ASPNET.StarterKit.Portal.AuditSystem.Module.EventAnswerReportFrame" %>
										...
										<TABLE class="TTable1" id="Table1" cellSpacing="3" cellPadding="3" width="100%" align="center"
											...
											<tr>
												<td align="center" colSpan="3">
													<asp:Label id="Label1" runat="server" CssClass="subhead">答詢時間：</asp:Label>
													<asp:textbox id="TextboxAnnDate" runat="server"></asp:textbox></FONT>
													<asp:Label id="Label2" runat="server" CssClass="subhead">擬答版本：</asp:Label>
