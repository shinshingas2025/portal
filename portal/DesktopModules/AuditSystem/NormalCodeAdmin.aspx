...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="NormalCodeAdmin.aspx.vb" Inherits="ASPNET.StarterKit.Portal.AuditSystem.Module.NormalCodeAdmin" %>
...
topMargin=0 rightMargin=0 marginheight="0" marginwidth="0">
		<form id="Form1" method="post" runat="server">
          ...
          ><asp:label id="Label7" runat="server" CssClass="itemtitle">一般代碼管理</asp:label></td>
										...
										<TABLE class="TTable1" id="Table1" cellSpacing="3" cellPadding="3" width="100%" align="center"
											...
											<tr>
												<td align="center">
													<table width="100%">
														...
														<tr>
															<td colSpan="2">說明：
																<asp:textbox id="TextBoxGroupDescription" runat="server" Columns="120"></asp:textbox></td>
														</tr>
														<tr>
											...
											<tr>
												<td align="center" width="100%">
													...
													<asp:TextBox id="TextBoxCodeName" runat="server" Width="300"></asp:TextBox>
													<asp:TextBox id="TextBoxCodeDescription" runat="server" Width="500"></asp:TextBox>
