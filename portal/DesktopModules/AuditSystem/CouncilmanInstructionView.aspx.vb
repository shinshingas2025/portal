...
Namespace ASPNET.StarterKit.Portal.AuditSystem.Module
	...
	Public Class CouncilmanInstructionView
			...
			If instructionID.Trim.Length > 0 Then
				...
				If myInstructionDataSet.Tables(0).Rows.Count = 1 Then
					...
					If myInstructionDataSet.Tables(0).Rows.Count > 0 Then
						...
						Next
						If bFound = True Then
							Response.Redirect("~/DesktopModules/AuditSystem/CouncilmanInstructionView.aspx?sid=" & sid & "&mid=" & moduleId & "&tabid=" & tabId & "&tabindex=" & tabIndex & "&instructionID=" & myPreviousID)
						End If
					End If
				Else
					'exception:instruction record is empty or duplicated
				...
				If myInstructionDataSet.Tables(0).Rows.Count = 1 Then
					...
					If myInstructionDataSet.Tables(0).Rows.Count > 0 Then
						...
						If bFound = True Then
							...
							End If
							Response.Redirect("~/DesktopModules/AuditSystem/CouncilmanInstructionView.aspx?sid=" & sid & "&mid=" & moduleId & "&tabid=" & tabId & "&tabindex=" & tabIndex & "&instructionID=" & myNextID)
						End If
					End If
				Else
