...
Namespace ASPNET.StarterKit.Portal.AuditSystem.Module
	...
	Public Class AffairProcessCheckReportByAttributeFrame
...
#Region " Web Form 設計工具產生的程式碼 "
		...
		Protected WithEvents DropDownListAttribute As System.Web.UI.WebControls.DropDownList
...
#End Region
		...
		Private IFrameSrc As String = ConfigurationSettings.AppSettings("ReportServerURL") & "?%2f%e5%a0%b1%e8%a1%a8%2f%e5%88%86%e9%a1%9e%e9%87%8d%e8%a6%81%e6%a5%ad%e5%8b%99%e5%a0%b1%e5%91%8a%e8%a1%a8&rc:Parameters=false"
		...
		Private Sub PageLoad()
			...
			DropDownListAttribute.Items.Clear()
			...
			If myAttributeCodeCount > 0 Then
				...
				For i = 0 To myAttributeCodeCount - 1
					myCodeID = CType(myAttributeCodeDataSet.Tables(0).Rows(i).Item("EntityID"), String)
					myCodeName = CType(myAttributeCodeDataSet.Tables(0).Rows(i).Item("Name"), String)

					myListItem = New ListItem
					myListItem.Value = myCodeID
					myListItem.Text = myCodeName

					DropDownListAttribute.Items.Add(myListItem)
				Next
			End If
		...
		Private Sub ButtonOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonOK.Click
			...
			myAttributeID = DropDownListAttribute.SelectedValue

			Me.Iframe1.Attributes("src") = IFrameSrc & "&StartDate=" & myStartDate & "&EndDate=" & myEndDate & "&GroupID=" & myGroupID & "&AttributeID=" & myAttributeID & "&MyRandomArg=" & myRandom
		End Sub
	End Class
End Namespace