...
Namespace ASPNET.StarterKit.Portal.AuditSystem.Module
	...
	Public Class InsuranceCodeAdminFrame
...
#End Region
		...
		Private Sub PageLoad()
			...
			myCodeDataSet = UtilityObject.QueryPermissionFilter(myCodeDataSet, InsuranceCodeAuthorityTarget, Context.User.Identity.Name)
		...
		Private Sub DropDownListCode_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DropDownListCode.SelectedIndexChanged
			Response.Redirect("~/DesktopModules/AuditSystem/InsuranceCodeAdminFrame.aspx?sid=" & sid & "&mid=" & moduleId & "&tabid=" & tabId & "&tabindex=" & tabIndex & "&codeID=" & DropDownListCode.SelectedValue)
		End Sub
		...
		Private Function SaveCodeData(ByVal myCodeID As String) As String
			...
			If myCodeID.Trim.Length > 0 Then
				'get authority
				If myAuthorityBO.CheckPurview(InsuranceCodeAuthorityTarget, myCodeID, Context.User.Identity.Name, "U") Then
					'update
		...
		Private Sub ButtonInsert_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonInsert.Click
			...
			If myCodeID.Trim.Length > 0 Then
				Response.Redirect("~/DesktopModules/AuditSystem/InsuranceCodeAdminFrame.aspx?sid=" & sid & "&mid=" & moduleId & "&tabid=" & tabId & "&tabindex=" & tabIndex & "&codeID=" & myCodeID)
			Else
		...
		Private Sub ButtonDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonDelete.Click
			...
			If codeID.Trim.Length > 0 Then
				'get authority
				If myAuthorityBO.CheckPurview(InsuranceCodeAuthorityTarget, codeID, Context.User.Identity.Name, "D") Then
