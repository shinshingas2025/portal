...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="ReportFrame07.aspx.vb" Inherits="ASPNET.StarterKit.Portal.AuditSystem.Module.ReportFrame07" %>
									...
									<TABLE class="TTable1" id="Table1" cellSpacing="3" cellPadding="3" width="100%" align="center"
										...
										<tr>
											<td align="center" colSpan="3"><FONT face="新細明體">
													<asp:Label id="Label1" runat="server" CssClass="subhead">版次：</asp:Label>
													<asp:textbox id="TextBoxVersion" runat="server"></asp:textbox>
													<asp:Label id="Label2" runat="server" CssClass="subhead">刊登日期：</asp:Label>
													<asp:textbox id="TextBoxAnnDate" runat="server"></asp:textbox></FONT></td>
										</tr>
										<tr>
