...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PolicyInsuranceLawCheckForm.aspx.vb" Inherits="ASPNET.StarterKit.Portal.AuditSystem.Module.PolicyInsuranceLawCheckForm" %>
...
topMargin=0 rightMargin=0 marginheight="0" marginwidth="0">
		<form id="Form1" method="post" runat="server">
          ...
          ><asp:label id="Label7" runat="server" CssClass="itemtitle">政策保險法規管理</asp:label></td>
														...
														<tr>
															...
															<td width="480" align="left">
																<table cellSpacing="0" cellPadding="0" align="left" width="100%" border="0">
																	<tr>
																		<td>
																			<table cellSpacing="0" cellPadding="0" align="left" width="100%" width="100%" border="0">
																				<tr>
																					<td>
																						<table cellSpacing="0" cellPadding="0" align="left" border="0">
																							<tr>
																								<td width="200"><ajax:ajaxpanel id="AjaxPanelMeeting" runat="server">
																										<TABLE cellSpacing="1" cellPadding="1" align="left" bgcolor="#FFFFFF" border="1" width="100%" style="border-collapse: collapse" height="160">
																											<TR>
																												<TD>會次次別</TD>
																												<TD>
																											...
																											<TR>
																												<TD>開會日期</TD>
																												<TD>
																													<asp:label CssClass="promo" id="LabelMeetingDate" runat="server"></asp:label></TD>
																											</TR>
																											<TR>
																												<TD>開會時間</TD>
																												<TD class="promo">
																											...
																											<TR>
																												<TD>開會地點</TD>
																												<TD>
																													<asp:label CssClass="promo" id="LabelPlace" runat="server"></asp:label></TD>
																											</TR>
																											<TR>
																												<TD>主席</TD>
																												<TD>
																													<asp:label CssClass="promo" id="LabelChairPerson" runat="server"></asp:label></TD>
																											</TR>
																										</TABLE>
																									</ajax:ajaxpanel></td>
																								<td>
											...
											<tr>
												<td>
													<table cellSpacing="0" cellPadding="0" align="left" border="0" width="100%">
														<tr>
															<td>
																<table cellSpacing="0" cellPadding="0" align="left" border="0" width="360">
																	<tr>
																		<td><ajax:ajaxpanel id="AjaxpanelLaw" runat="server">
																				<TABLE cellSpacing="1" cellPadding="1" align="left" bgcolor="#FFFFFF" border="1" width="100%" style="border-collapse: collapse" height="250">
																					<TR>
																						<TD>法規名稱</TD>
																						<TD colSpan="3">
																							<asp:dropdownlist id="DropDownListLaw" Runat="server" OnSelectedIndexChanged="DropDownListLaw_SelectedIndexChanged"
																								AutoPostBack="True"></asp:dropdownlist></TD>
																					</TR>
																					<TR>
																						<TD>法規訂定日期</TD>
																						<TD>
																							<asp:label CssClass="promo" id="LabelConstitutionDate" Runat="server"></asp:label></TD>
																						<TD>審議階段</TD>
																						<TD>
																							<asp:label CssClass="promo" id="LabelDiscussion" Runat="server"></asp:label></TD>
																					</TR>
																					<TR>
																						<TD>法規條次及內容</TD>
																						<TD colSpan="3">
																							<asp:label CssClass="promo" id="LabelLawContent" Runat="server"></asp:label></TD>
																					</TR>
																					<TR>
																						<TD>母法依據</TD>
																						<TD colSpan="3">
																							<asp:label CssClass="promo" id="LabelParent" Runat="server"></asp:label></TD>
																					</TR>
																				</TABLE>
																			</ajax:ajaxpanel>
																		</td>
																		...
																		<td>
																			<table cellSpacing="1" cellPadding="1" align="left" bgcolor="#FFFFFF" border="1" width="100%" style="border-collapse: collapse" height="250">
																				...
																				<tr>
																					...
																					<td><asp:textbox id="TextBoxProcessDate" Runat="server"></asp:textbox></td>
																					<td><asp:label id="LabelForecastDateMark" Runat="server">預定完成日期</asp:label></td>
																					<td><asp:textbox id="TextBoxForecastDate" Runat="server"></asp:textbox></td>
																				</tr>
																				<tr>
																				...
																				<tr>
																					...
																					<td><asp:textbox id="TextBoxConcludeDate" Runat="server"></asp:textbox></td>
