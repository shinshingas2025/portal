<%@ Page Language="vb" AutoEventWireup="false" Codebehind="EventAnserQuery.aspx.vb" Inherits="ASPNET.StarterKit.Portal.AuditSystem.Module.EventAnserQuery" %>
		...
		<form id="Form1" method="post" runat="server">
			<FONT face="新細明體">
				<TABLE id="Table1" height="348" cellSpacing="0" cellPadding="0" width="760" border="0">
					...
					<TR>
						<TD width="113" height="16"><A href="EventAnserEdit.aspx">新增</A></TD>
						<TD height="16"></TD>
					</TR>
					<TR>
						<TD vAlign="top" width="38" colSpan="2"><asp:datagrid id="DataGrid1" runat="server" DataKeyField="EntityID" AllowPaging="True" Font-Size="X-Small"
								...
								<Columns>
									<asp:BoundColumn DataField="Newspaper" HeaderText="報紙名稱"></asp:BoundColumn>
									<asp:BoundColumn DataField="Version" HeaderText="版次"></asp:BoundColumn>
									<asp:BoundColumn DataField="AnnDate" HeaderText="刋登日期"></asp:BoundColumn>
									<asp:BoundColumn DataField="Subject" HeaderText="議題"></asp:BoundColumn>
