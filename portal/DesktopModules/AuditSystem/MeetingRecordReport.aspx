...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="MeetingRecordReport.aspx.vb" Inherits="ASPNET.StarterKit.Portal.AuditSystem.Module.MeetingRecordReport" %>
...
topMargin=0 rightMargin=0 marginwidth="0" marginheight="0">
		<form id="Form1" method="post" runat="server">
          ...
          ><asp:label id="Label7" runat="server" CssClass="itemtitle">會議記錄報表</asp:label></td>
										...
										<TABLE class="TTable1" id="Table1" cellSpacing="3" cellPadding="3" width="100%" align="center"
											...
											<tr>
												<td align="center" colSpan="3"><FONT face="新細明體">
														<asp:Label id="Label3" runat="server" CssClass="subhead">會議記錄類型： </asp:Label>
														<asp:DropDownList id="DropDownListType" runat="server"></asp:DropDownList><FONT face="新細明體">
															<asp:Label id="Label2" runat="server" CssClass="subhead">會次：</asp:Label></FONT>
														<asp:textbox id="TextBoxMeetingNumber" runat="server"></asp:textbox></FONT></td>
											</tr>
											<tr>
