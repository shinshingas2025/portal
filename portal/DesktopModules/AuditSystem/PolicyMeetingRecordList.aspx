...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="PolicyMeetingRecordList.aspx.vb" Inherits="ASPNET.StarterKit.Portal.AuditSystem.Module.PolicyMeetingRecordList" %>
									...
									<TR>
										...
										<TD width="10%">
											<ASP:LABEL id="Label3" runat="server">
												<%# DataBinder.Eval(Container.DataItem, "MeetingNumber") %>
											</ASP:LABEL></TD>
										<TD width="70%">
										...
										<TD width="15%">
											<ASP:LABEL id="Label2" runat="server">
												<%# DataBinder.Eval(Container.DataItem, "MeetingDateString") %>
											</ASP:LABEL>
										</TD>
									</TR>
								</TABLE>
