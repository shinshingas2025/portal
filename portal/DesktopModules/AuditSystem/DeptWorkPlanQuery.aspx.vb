...
Namespace ASPNET.StarterKit.Portal.AuditSystem.Module
	Public Class DeptWorkPlanQuery
...
#End Region
		...
		Private Sub queryREC()
			...
			CreatorID = ""
			ModifierID = ""
			txtDateS = CType(CInt(txtYearS.SelectedValue) + 1911, String) & "/" & txtMonthS.SelectedValue & "/01"

			DataGrid1.DataSource = objSPDAO.GetEntitys(Team.SelectedValue, CType(txtDateS, Date))
			DataGrid1.DataBind()
		End Sub
		...
		Private Sub DataGrid1_EditCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles DataGrid1.EditCommand
			Dim EntityID As String
			EntityID = CType(DataGrid1.DataKeys(e.Item.ItemIndex), String)
			Response.Redirect("DeptWorkplanEdit.aspx?EntityID=" & EntityID)
		End Sub
