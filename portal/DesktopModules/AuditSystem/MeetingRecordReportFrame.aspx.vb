...
Namespace ASPNET.StarterKit.Portal.AuditSystem.Module
	...
	Public Class MeetingRecordReportFrame
...
#End Region
		...
		Private IFrameSrc As String = ConfigurationSettings.AppSettings("ReportServerURL") & "?%2f%e5%a0%b1%e8%a1%a8%2f%e6%9c%83%e8%ad%b0%e8%a8%98%e9%8c%84&rc:Parameters=false"
		...
		Private Sub ButtonOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonOK.Click
			...
			Dim myMeetingNumber As String = ""

			If TextBoxMeetingNumber.Text.Trim <> "" Then
				myMeetingNumber = TextBoxMeetingNumber.Text.Trim
			End If

			myTypeID = DropDownListType.SelectedValue

			Me.Iframe1.Attributes("src") = IFrameSrc & "&TypeID=" & myTypeID & "&MeetingNumber=" & myMeetingNumber & "&MyRandomArg=" & myRandom
		End Sub
	End Class
End Namespace