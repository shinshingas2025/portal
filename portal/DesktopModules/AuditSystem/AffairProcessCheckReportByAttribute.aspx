...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="AffairProcessCheckReportByAttribute.aspx.vb" Inherits="ASPNET.StarterKit.Portal.AuditSystem.Module.AffairProcessCheckReportByAttribute" %>
...
topMargin=0 rightMargin=0 marginwidth="0" marginheight="0">
		<form id="Form1" method="post" runat="server">
          ...
          ><asp:label id="Label7" runat="server" CssClass="itemtitle">各類重要業務報告表</asp:label></td>
										...
										<TABLE class="TTable1" id="Table1" cellSpacing="3" cellPadding="3" width="100%" align="center"
											...
											<tr>
												<td align="center" colSpan="3"><FONT face="新細明體">
														...
														<asp:textbox id="TextBoxStartDate" runat="server" Width="103px"></asp:textbox>
														<asp:Label id="Label2" runat="server" CssClass="subhead">終止時間：</asp:Label>
														<asp:textbox id="TextBoxEndDate" runat="server" Width="102px"></asp:textbox>
														<asp:Label id="Label3" runat="server" CssClass="subhead">組別： </asp:Label>
														<asp:DropDownList id="DropDownListGroup" runat="server"></asp:DropDownList>
														<asp:Label id="Label4" runat="server">類別：</asp:Label>
														<asp:DropDownList id="DropDownListAttribute" runat="server"></asp:DropDownList></FONT></td>
											</tr>
											<tr>
