...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="AttributeCodeAdmin.aspx.vb" Inherits="ASPNET.StarterKit.Portal.AuditSystem.Module.AttributeCodeAdmin" %>
...
topMargin=0 rightMargin=0 marginheight="0" marginwidth="0">
		<form id="Form1" method="post" runat="server">
          ...
          ><asp:label id="Label7" runat="server" CssClass="itemtitle">處理屬性代碼管理</asp:label></td>
											...
											<tr>
												<td align="center">
													<table width="100%">
														...
														<tr>
															<td colSpan="2">說明：
																<asp:textbox id="TextBoxDescription" runat="server" Columns="120"></asp:textbox></td>
														</tr>
														<tr>
