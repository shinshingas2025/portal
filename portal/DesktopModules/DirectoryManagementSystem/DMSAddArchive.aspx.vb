			...
			If folderID.Trim.Length > 0 Then
				...
				Else
					...
					If Not (myFile Is Nothing) Then
						...
						End If
					End If
					myFileDAO.InsertEntity(0, myName, myPhysicalFileName, myFileSize, folderID, myDescription, myMetaData, myPermission, myOwner, myMajorRevision, myMinorRevision, myURL, myPassword, myDocumentType, "", "", 0, 0, Now, Now)
				End If
			Else
