...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="DMSDownloadFolder.aspx.vb" Inherits="ASPNET.StarterKit.Portal.DMSDownloadFolder" %>
...
topMargin=0 rightMargin=0 marginheight="0" marginwidth="0">
		<form id="Form1" method="post" runat="server">
          ...
          ><asp:label id="Label7" runat="server" CssClass="itemtitle">下載目錄</asp:label></td>
