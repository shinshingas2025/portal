...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="DMSModifyFolder.aspx.vb" Inherits="ASPNET.StarterKit.Portal.DMSModifyFolder" %>
...
topMargin=0 rightMargin=0 marginheight="0" marginwidth="0">
		<form id="Form1" method="post" runat="server">
          ...
          ><asp:label id="LabelDetail" runat="server" CssClass="itemtitle">修改目錄</asp:label></td>
												...
												<td align="center" colSpan="3">
													<table cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
														<tr>
															...
															<td align="left"><asp:textbox id="TextBoxName" runat="server"></asp:textbox><asp:requiredfieldvalidator id="RequiredFieldValidator1" runat="server" ErrorMessage="請輸入目錄名稱!" ControlToValidate="TextBoxName"
														...
														<tr>
															<td width="79"><FONT face="新細明體">原密碼</FONT></td>
															<td><asp:textbox id="TextBoxOldPassword" runat="server"></asp:textbox>
