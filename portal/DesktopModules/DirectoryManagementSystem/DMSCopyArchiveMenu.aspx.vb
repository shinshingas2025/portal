...
Namespace ASPNET.StarterKit.Portal
	Public Class DMSCopyArchiveMenu
		...
		Private Sub ShowDirectory(ByVal directoryID As String, ByVal depth As Integer)
			...
			If directoryID.Length > 0 Then
				...
				If myFolderDataSet.Tables(0).Rows.Count = 1 Then
					...
					Else
						myHyperLinkControl.NavigateUrl = "DMSCopyArchive.aspx?sid=" & sid & "&mid=" & moduleId & "&tabid=" & tabId & "&tabindex=" & tabIndex & "&folderID=" & folderID & "&fileID=" & fileID & "&targetFolderID=" & directoryID
					End If
