...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="DMSMoveArchiveMenu.aspx.vb" Inherits="ASPNET.StarterKit.Portal.DMSMoveArchiveMenu" %>
...
topMargin=0 rightMargin=0 marginwidth="0" marginheight="0">
		<form id="Form1" method="post" runat="server">
          ...
          ><asp:label id="Label7" runat="server" CssClass="itemtitle">選擇目錄</asp:label></td>
					...
					<tr>
						...
						<td width="100%">
							<TABLE width="100%" cellpadding="0" cellspacing="0" class="border2">
								<tr>
									<td class="stats1">操作檔案：
										<asp:HyperLink id="HyperLink1" runat="server" class="text"></asp:HyperLink>
									</td>
								</tr>
								<tr>
