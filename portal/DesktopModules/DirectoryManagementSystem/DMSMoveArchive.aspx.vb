								...
								If myFileCount = 0 Then
									...
									If myFileCount > 0 Then
										...
										For i = 0 To myFileCount - 1
											...
											myFileDAO.UpdateEntity(myFileID, myName, myFileName, myFileSize, targetFolderID, myDescription, myMetaData, myPermission, myOwner, myMajorRevision, myMinorRevision, myURL, myPassword, myDocumentTypeID, "", "", 0, Now)
										Next
									End If
								Else
									'name duplicated
