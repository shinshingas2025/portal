...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="DMSMoveArchive.aspx.vb" Inherits="ASPNET.StarterKit.Portal.DMSMoveArchive" %>
...
topMargin=0 rightMargin=0 marginheight="0" marginwidth="0">
		<form id="Form1" method="post" runat="server">
          ...
          ><asp:label id="Label7" runat="server" CssClass="itemtitle">複製檔案</asp:label></td>
