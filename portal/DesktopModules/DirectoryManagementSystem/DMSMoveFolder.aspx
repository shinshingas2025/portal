...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="DMSMoveFolder.aspx.vb" Inherits="ASPNET.StarterKit.Portal.DMSMoveFolder" %>
...
topMargin=0 rightMargin=0 marginheight="0" marginwidth="0">
		<form id="Form1" method="post" runat="server">
          ...
          ><asp:label id="Label7" runat="server" CssClass="itemtitle">移動目錄</asp:label></td>
