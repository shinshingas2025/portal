...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="DMSCopyFolder.aspx.vb" Inherits="ASPNET.StarterKit.Portal.DMSCopyFolder" %>
...
topMargin=0 rightMargin=0 marginheight="0" marginwidth="0">
		<form id="Form1" method="post" runat="server">
          ...
          ><asp:label id="Label7" runat="server" CssClass="itemtitle">複製目錄</asp:label></td>
