...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="DMSDirectoryTree.aspx.vb" Inherits="ASPNET.StarterKit.Portal.DMSDirectoryTree" %>
...
topMargin=0 rightMargin=0 marginwidth="0" marginheight="0">
		<form id="Form1" method="post" runat="server">
          ...
          ><asp:label id="Label7" runat="server" CssClass="itemtitle">目錄結構</asp:label></td>
