...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="DMSLogArchive.aspx.vb" Inherits="ASPNET.StarterKit.Portal.DMSLogArchive" %>
...
topMargin=0 rightMargin=0 marginwidth="0" marginheight="0">
		<form id="Form1" method="post" runat="server">
          ...
          ><asp:label id="Label7" runat="server" CssClass="itemtitle">檔案記錄</asp:label></td>
