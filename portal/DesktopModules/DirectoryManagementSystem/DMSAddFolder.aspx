...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="DMSAddFolder.aspx.vb" Inherits="ASPNET.StarterKit.Portal.DMSAddFolder" %>
...
topMargin=0 rightMargin=0 marginheight="0" marginwidth="0">
		<form id="Form1" method="post" runat="server">
          ...
          ><asp:label id="LabelDetail" runat="server" CssClass="itemtitle">新增目錄</asp:label></td>
