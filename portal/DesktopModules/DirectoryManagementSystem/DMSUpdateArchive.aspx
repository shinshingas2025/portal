...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="DMSUpdateArchive.aspx.vb" Inherits="ASPNET.StarterKit.Portal.DMSUpdateArchive" %>
...
topMargin=0 rightMargin=0 marginwidth="0" marginheight="0">
		<form id="Form1" method="post" runat="server" encType="multipart/form-data">
          ...
          ><asp:label id="LabelDetail" runat="server" CssClass="itemtitle">更新檔案</asp:label></td>
												...
												<td align="center" colSpan="3">
													<table cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
														...
														<tr>
															...
															<td><asp:textbox id="TextBoxPassword" runat="server"></asp:textbox>
