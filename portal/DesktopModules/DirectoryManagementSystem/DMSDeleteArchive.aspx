...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="DMSDeleteArchive.aspx.vb" Inherits="ASPNET.StarterKit.Portal.DMSDeleteArchive" %>
...
topMargin=0 rightMargin=0 marginheight="0" marginwidth="0">
		<form id="Form1" method="post" encType="multipart/form-data" runat="server">
          ...
          ><asp:label id="LabelDetail" runat="server" CssClass="itemtitle">刪除檔案</asp:label></td>
