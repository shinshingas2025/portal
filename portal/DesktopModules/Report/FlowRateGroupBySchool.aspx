...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="FlowRateGroupBySchool.aspx.vb" Inherits="ASPNET.StarterKit.Portal.FlowRateGroupBySchool" %>
...
topMargin=0 rightMargin=0 marginheight="0" marginwidth="0">
		<form id="Form1" method="post" runat="server">
          ...
          ><asp:label id="Label7" runat="server" CssClass="itemtitle">各校流量分析報表</asp:label></td>
										...
										<TABLE class="TTable1" id="Table1" cellSpacing="3" cellPadding="3" width="100%" align="center"
											...
											<tr>
												<td align="center" colSpan="3">
													<asp:Button id="ButtonOK" runat="server" Text="更新"></asp:Button></td>
											</tr>
											<tr>
