...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="JobWantedList.aspx.vb" Inherits="ASPNET.StarterKit.Portal.JobWantedList" %>
...
topMargin=0 rightMargin=0 marginheight="0" marginwidth="0">
		<form id="Form1" method="post" runat="server">
          ...
          ><asp:label id="Label7" runat="server" CssClass="itemtitle">求職報表</asp:label></td>
											...
											<tr>
												<td align="center" colSpan="3">
													<table width="100%" border="0" cellSpacing="0" cellPadding="0" align="center">
														<tr>
															<td><FONT face="新細明體">
																	<asp:Label id="Label1" runat="server" CssClass="subhead">畢業年度：</asp:Label>
																	<asp:TextBox id="TextBoxYear" runat="server" Width="96px"></asp:TextBox>
																	<asp:RequiredFieldValidator id="RequiredFieldValidator4" runat="server" ControlToValidate="TextBoxYear" Display="Dynamic"
																		ErrorMessage="請輸入畢業年度!" CssClass="normalred"></asp:RequiredFieldValidator>
																	<asp:RegularExpressionValidator id="RegularExpressionValidator3" runat="server" ControlToValidate="TextBoxYear"
																		Display="Dynamic" ErrorMessage="年度格式(西元年)" ValidationExpression="\d{1,4}"></asp:RegularExpressionValidator></FONT></td>
														</tr>
													</table>
												</td>
											</tr>
											<tr>
												<td align="center" colSpan="3">
													<table width="100%" border="0" cellSpacing="0" cellPadding="0" align="center">
														<tr>
															<td><FONT face="新細明體">
																	<asp:Label id="Label2" runat="server" CssClass="subhead">查詢起始日期：</asp:Label>
															...
															<td><FONT face="新細明體">
																	<asp:Label id="Label3" runat="server" CssClass="subhead">查詢終止日期：</asp:Label><asp:TextBox id="TextBoxEndDate" runat="server"></asp:TextBox>
