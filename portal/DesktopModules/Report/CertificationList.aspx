...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="CertificationList.aspx.vb" Inherits="ASPNET.StarterKit.Portal.CertificationList" %>
...
topMargin=0 rightMargin=0 marginheight="0" marginwidth="0">
		<form id="Form1" method="post" runat="server">
          ...
          ><asp:label id="Label7" runat="server" CssClass="itemtitle">在校生／畢業生技術證照表</asp:label></td>
											...
											<tr>
												<td align="center" colSpan="3">
													<P><FONT face="新細明體">
															...
															<asp:RequiredFieldValidator id="RequiredFieldValidator1" runat="server" ErrorMessage="請輸入查詢年度!!" ControlToValidate="TextBoxYear"
																Display="Dynamic" CssClass="normalred"></asp:RequiredFieldValidator>
															<asp:RegularExpressionValidator id="RegularExpressionValidator1" runat="server" ErrorMessage="輸入格式錯誤!!" ControlToValidate="TextBoxYear"
																ValidationExpression="\d{1,4}" Display="Dynamic"></asp:RegularExpressionValidator></FONT><FONT face="新細明體"></P>
													</FONT></td>
											</tr>
											<tr>
												<td align="center" colSpan="3">
