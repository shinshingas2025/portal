...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="TalentWantedListGroupByTime.aspx.vb" Inherits="ASPNET.StarterKit.Portal.TalentWantedListGroupByTime" %>
...
topMargin=0 rightMargin=0 marginheight="0" marginwidth="0">
		<form id="Form1" method="post" runat="server">
          ...
          ><asp:label id="Label7" runat="server" CssClass="itemtitle">求才登記區間名冊</asp:label></td>
