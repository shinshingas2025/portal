...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="OutletList.aspx.vb" Inherits="ASPNET.StarterKit.Portal.OutletList" %>
...
topMargin=0 rightMargin=0 marginheight="0" marginwidth="0">
		<form id="Form1" method="post" runat="server">
          ...
          ><asp:label id="Label7" runat="server" CssClass="itemtitle">畢業生出路調查表</asp:label></td>
											...
											<tr>
												<td align="center" colSpan="3">
													<table width="100%" border="0" cellSpacing="0" cellPadding="0" align="center">
														<tr>
															<td><FONT face="新細明體">
																	<asp:Label id="Label1" runat="server">畢業年度：</asp:Label>
