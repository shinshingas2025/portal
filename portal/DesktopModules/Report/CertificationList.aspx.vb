...
#End Region
		...
		Private ProcedureName As String = "SP_PORTAL_RPT02"
		Private IFrameSrc As String = ConfigurationSettings.AppSettings("ReportServerURL") & "?%2f%e5%a0%b1%e8%a1%a8%2f%e5%9c%a8%e6%a0%a1%e7%94%9f%e7%95%a2%e6%a5%ad%e7%94%9f%e6%8a%80%e8%a1%93%e8%ad%89%e7%85%a7%e8%a1%a8&rc:Parameters=false"
		...
		Private Sub ButtonOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonOK.Click
			...
			'Dim myRandom As Integer = Now.Second
			'Dim myGradYear As Integer = Now.Year
			...
			If sid.Trim.Length > 0 Then
				...
				If mySiteDataSet.Tables(0).Rows.Count = 1 Then
					...
					myGradYear = CType(TextBoxYear.Text, Integer)
					CallProcedure(ProcedureName, mySchoolCode, myGradYear)
					Me.Iframe1.Attributes("src") = IFrameSrc & "&Parameter1=" & mySchoolCode & "&Parameter2=" & myRandom & "&Gyear=" & myGradYear
				Else
