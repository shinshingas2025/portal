...
#End Region
        ...
        '
        ' It then uses the ASPNET.StarterKit.PortalDocumentDB() data component
        ...
        ' create or update an document.  It  uses the ASPNET.StarterKit.PortalDocumentDB()
        ...
        ' a document.  It  uses the ASPNET.StarterKit.PortalDocumentsDB()
        ' data component to encapsulate all data functionality.
        '
        '****************************************************************
