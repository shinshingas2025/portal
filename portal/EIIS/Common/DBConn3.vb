...
Public Class DBConn3
    ...
    Dim ServerIP As String = Configration.DBServerName3
    Dim Account As String = Configration.DBUserId3
    Dim pwd As String = Configration.DBPassword3
    Dim DbName As String = Configration.DBDatabase3
