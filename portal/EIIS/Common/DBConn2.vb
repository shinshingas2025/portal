...
Public Class DBConn2
    ...
    Dim ServerIP As String = Configration.DBServerName2
    Dim Account As String = Configration.DBUserId2
    Dim pwd As String = Configration.DBPassword2
    Dim DbName As String = Configration.DBDatabase2
    ...
    Function ExecuteReader(ByVal SQL As String) As SqlDataReader
        Dim sc As New SqlCommand
