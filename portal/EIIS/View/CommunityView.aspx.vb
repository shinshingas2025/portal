...
#End Region
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If Not IsPostBack Then
                '在這裡放置使用者程式碼以初始化網頁
                'If viewstate("tree") Is Nothing Then
                '    treeFile = "tree.xml"
                '    viewstate("tree") = "tree.xml"
                'Else
                '    treeFile = viewstate("tree")
                'End If
        ...
        Private Function GetTempTreeFile() As String
            Dim fn As String
            fn = "CA_" & Year(Now()) & Right("0" & Month(Now()), 2) & Right("0" & Day(Now()), 2) & Right("0" & Hour(Now()), 2) & Right("0" & Minute(Now()), 2) & Right("0" & Second(Now()), 2) & ".xml"
            Return fn
        End Function
        ...
        Private Sub ShowTree(ByVal treeFile As String)
            ...
            Dim fls() As String = Directory.GetFiles(Server.MapPath("/PortalFiles/xml/TreeView"), "CA_*.xml")

            If UBound(fls) < 1 Then
                WriteXmlTree()
                fls = Directory.GetFiles(Server.MapPath("/PortalFiles/xml/TreeView"), "CA_*.xml")
        ...
        Private Sub addfunction_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles addfunction.Click
            txtState.Text = CType(ShowDialogBox(txtState, "DomainsListView.aspx?UID=" & txtobjID.Text.Trim, 400, 520, 0, 0, True), String)
        End Sub
        ...
        Private Sub DataGrid4_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DataGrid4.SelectedIndexChanged
