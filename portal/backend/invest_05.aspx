<%@ Page Language="vb" AutoEventWireup="false" Codebehind="invest_05.aspx.vb" Inherits="invest_05" %>
						...
						<tr>
							<td align="center">
								<form id="Form1" method="post" encType="multipart/form-data" runat="server">
									<DIV align="left">
										<asp:datagrid id="dgCart" runat="server" GridLines="None" AllowSorting="True" OnDeleteCommand="dgCart_Delete"
											...
											<Columns>
												<asp:BoundColumn DataField="invname" HeaderText="董事會議資料主旨">
												...
												<asp:HyperLinkColumn Text="編輯" DataNavigateUrlField="invno" DataNavigateUrlFormatString="invest_05.aspx?invno={0}"
									...
									<P align="left">
										<TABLE id="Table5" height="216" cellSpacing="1" cellPadding="1" width="600" bgColor="#003399"
											...
											<TBODY>
												<TR>
													<TD width="130" bgColor="lavender" height="28">
														<P><FONT face="新細明體"><FONT color="#000000" size="2"><STRONG style="Z-INDEX: 0">董事會議資料主旨</STRONG></FONT></FONT></P>
													</TD>
												...
												<TR>
													<TD width="130" bgColor="lavender" height="28"><FONT color="#000000" size="2"><STRONG>附表上傳</STRONG></FONT></TD>
													<TD width="185" bgColor="#ffffff" colSpan="3" height="28"><FONT face="新細明體"><FONT color="#000000" size="2"><STRONG></STRONG></FONT></FONT><FONT face="新細明體"><asp:label id="txtdbfile" runat="server"></asp:label><INPUT id="txtfile" type="file" size="46" name="txtfile" runat="server">
														</FONT>
													</TD>
												</TR>
												<TR>
