...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="dividend.aspx.vb" Inherits="dividend" aspcompat="true" %>
			...
			<tr>
				<td vAlign="middle" align="center">
					<table cellSpacing="0" cellPadding="3" width="100%" border="0">
						<tr>
							<td width="94">&nbsp;</td>
							<td width="26%"><font color="red" size="2"><b>&gt;&gt;</b> <font color="#003366" size="2">股利發放相關資訊</font></font></td>
							<td width="65%">&nbsp;</td>
						</tr>
					</table>
				</td>
									...
									<form id="Form1" method="post" runat="server">
										<asp:datagrid id="dgCart" runat="server" OnCancelCommand="dgCart_Cancel" OnDeleteCommand="dgCart_Delete"
											...
											<Columns>
												...
												<asp:BoundColumn DataField="mon01" HeaderText="現金股利">
													<HeaderStyle ForeColor="White"></HeaderStyle>
												</asp:BoundColumn>
												<asp:BoundColumn DataField="mon02" HeaderText="現金股利發放日">
													<HeaderStyle ForeColor="White"></HeaderStyle>
												</asp:BoundColumn>
												<asp:BoundColumn DataField="mon03" HeaderText="盈餘配股">
													<HeaderStyle ForeColor="White"></HeaderStyle>
												</asp:BoundColumn>
												<asp:BoundColumn DataField="mon04" HeaderText="公積配股">
													<HeaderStyle ForeColor="White"></HeaderStyle>
												</asp:BoundColumn>
												<asp:BoundColumn DataField="mon05" HeaderText="股票股利發放日">
													<HeaderStyle ForeColor="White"></HeaderStyle>
												</asp:BoundColumn>
												<asp:BoundColumn DataField="mon06" HeaderText="除權息交易日">
													<HeaderStyle ForeColor="White"></HeaderStyle>
												</asp:BoundColumn>
												<asp:BoundColumn DataField="mon07" HeaderText="股東會日期">
													<HeaderStyle ForeColor="White"></HeaderStyle>
												</asp:BoundColumn>
												<asp:HyperLinkColumn Text="編輯" DataNavigateUrlField="newno" DataNavigateUrlFormatString="dividend.aspx?newno={0}"
										...
										<p>
											<TABLE id="Table5" height="216" cellSpacing="1" cellPadding="1" width="500" bgColor="#003399"
												...
												<TBODY>
													...
													<TR>
														<TD align="right" width="185" bgColor="lavender" height="27">
															<P><FONT face="新細明體"><FONT color="#000000" size="2"><STRONG>現金股利</STRONG></FONT></FONT></P>
														</TD>
														<TD width="315" bgColor="#ffffff" colSpan="3" height="27"><FONT face="新細明體" size="2"><asp:textbox id="Textbox1" runat="server" Width="150px"></asp:textbox>(Ex:99.99)</FONT></TD>
													</TR>
													<TR>
														<TD align="right" width="185" bgColor="lavender" height="27">
															<P><FONT face="新細明體"><FONT color="#000000" size="2"><STRONG>現金股利發放日</STRONG></FONT></FONT></P>
														</TD>
														<TD width="315" bgColor="#ffffff" colSpan="3" height="27"><FONT face="新細明體" size="2"><asp:textbox id="Textbox2" runat="server" Width="150px"></asp:textbox>(Ex:101/01/01)</FONT></TD>
													</TR>
													<TR>
														<TD align="right" width="185" bgColor="lavender" height="27">
															<P><FONT face="新細明體"><FONT color="#000000" size="2"><STRONG>盈餘配股</STRONG></FONT></FONT></P>
														</TD>
														<TD width="315" bgColor="#ffffff" colSpan="3" height="27"><FONT face="新細明體" size="2"><asp:textbox id="Textbox3" runat="server" Width="150px"></asp:textbox>(Ex:99.99)</FONT></TD>
													</TR>
													<TR>
														<TD align="right" width="185" bgColor="lavender" height="27">
															<P><FONT face="新細明體"><FONT color="#000000" size="2"><STRONG>公積配股</STRONG></FONT></FONT></P>
														</TD>
														<TD width="315" bgColor="#ffffff" colSpan="3" height="27"><FONT face="新細明體" size="2"><asp:textbox id="Textbox4" runat="server" Width="150px"></asp:textbox>(Ex:99.99)</FONT></TD>
													</TR>
													<TR>
														<TD align="right" width="185" bgColor="lavender" height="27">
															<P><FONT face="新細明體"><FONT color="#000000" size="2"><STRONG>股票股利發放日</STRONG></FONT></FONT></P>
														</TD>
														<TD width="315" bgColor="#ffffff" colSpan="3" height="27"><FONT face="新細明體" size="2"><asp:textbox id="Textbox5" runat="server" Width="150px"></asp:textbox>(Ex:101/01/01)</FONT></TD>
													</TR>
													<TR>
														<TD align="right" width="185" bgColor="lavender" height="27">
															<P><FONT face="新細明體"><FONT color="#000000" size="2"><STRONG>除權息交易日</STRONG></FONT></FONT></P>
														</TD>
														<TD width="315" bgColor="#ffffff" colSpan="3" height="27"><FONT face="新細明體" size="2"><asp:textbox id="Textbox6" runat="server" Width="150px"></asp:textbox>(Ex:101/01/01)</FONT></TD>
													</TR>
													<TR>
														<TD align="right" width="185" bgColor="lavender" height="27">
															<P><FONT face="新細明體"><FONT color="#000000" size="2"><STRONG>股東會日期</STRONG></FONT></FONT></P>
														</TD>
														<TD width="315" bgColor="#ffffff" colSpan="3" height="27"><FONT face="新細明體" size="2"><asp:textbox id="Textbox7" runat="server" Width="150px"></asp:textbox>(Ex:101/01/01)</FONT></TD>
													</TR>
													<TR>
