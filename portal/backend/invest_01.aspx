<%@ Page Language="vb" AutoEventWireup="false" Codebehind="invest_01.aspx.vb" Inherits="invest_01" %>
<HEAD>
	<title>tmp</title>
		...
		<table cellSpacing="0" cellPadding="0" width="164" border="0">
			<tr>
				...
				<TD vAlign="top" width="140" bgColor="#0099cc">
					<P><FONT size="2">&nbsp;<FONT color="#ffffff">檔案送件規格文件上傳</FONT></FONT></P>
				</TD>
			</tr>
		</table>
		<P>
			<asp:datagrid id="dgCart" runat="server" BorderStyle="Ridge" BorderWidth="0px" CellPadding="2"
				ShowFooter="True" DataKeyField="invno" AllowPaging="True" AutoGenerateColumns="False" BorderColor="White"
				BackColor="White" Width="100%" OnDeleteCommand="dgCart_Delete" AllowSorting="True" GridLines="None"
				CellSpacing="1">
				...
				<Columns>
					...
					<asp:HyperLinkColumn Text="編輯" DataNavigateUrlField="invno" DataNavigateUrlFormatString="invest_01.aspx?invno={0}"
			...
			<DIV align="left"><FONT face="新細明體">
						...
						<TABLE id="Table5" height="60" cellSpacing="1" cellPadding="1" width="600" bgColor="#003399"
							...
							<TBODY>
								<TR>
									...
									<TD width="185" bgColor="#ffffff" colSpan="3" height="28"><FONT face="新細明體"></FONT><FONT face="新細明體"></FONT><FONT face="新細明體">
											<asp:textbox id="txtname" runat="server" Width="376px"></asp:textbox></FONT></TD>
								</TR>
								<TR>
									...
									<TD width="185" bgColor="#ffffff" colSpan="3" height="28"><FONT face="新細明體"><FONT color="#000000" size="2"><STRONG></STRONG></FONT></FONT><FONT face="新細明體">
											<asp:label id="txtdbfile" runat="server"></asp:label><INPUT id="txtfile" type="file" size="43" name="txtfile" runat="server">
										</FONT>
									</TD>
								</TR>
								<TR>
				...
				<TR>
					<TD align="left" width="173" bgColor="#ffffff" colSpan="4">
