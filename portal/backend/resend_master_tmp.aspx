<%@ Page Language="vb" AutoEventWireup="false" Codebehind="resend_master_tmp.aspx.vb" Inherits="resend_master_tmp" %>
<HTML>
	<HEAD>
		<title>tmp</title>
		...
		<FORM id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="135" border="0">
				<tr>
					...
					<TD vAlign="top" width="110" bgColor="#0099cc">
						<P><FONT size="2">&nbsp;<FONT color="#ffffff">保險商品送件補正</FONT></FONT></P>
					</TD>
				</tr>
			</table>
			<FONT face="新細明體">
				<P><asp:datagrid id="dgCart" GridLines="None" AllowSorting="True" PageSize="6" OnDeleteCommand="dgCart_Delete"
						...
						<Columns>
							<asp:BoundColumn DataField="faqquestion" HeaderText="送件文號">
								<HeaderStyle ForeColor="White" Width="13%"></HeaderStyle>
							</asp:BoundColumn>
							...
							<asp:HyperLinkColumn Text="編輯" DataNavigateUrlField="faqno" DataNavigateUrlFormatString="resend_detail_tmp.aspx?faqno={0}"
					...
					<TABLE id="Table5" height="216" cellSpacing="1" cellPadding="1" width="600" bgColor="#003399"
						...
						<TBODY>
							...
							<TR>
								...
								<TD width="185" bgColor="#ffffff" colSpan="3" height="27"><asp:radiobutton id="RadioButton1" runat="server" Text="核准"></asp:radiobutton>&nbsp;
									<asp:dropdownlist id="etxtfaqgrp" runat="server" Width="288px">
									...
									</asp:dropdownlist><asp:radiobutton id="RadioButton2" runat="server" Text="備查"></asp:radiobutton>&nbsp;
									<asp:dropdownlist id="etxttype" runat="server">
							...
							<TR>
								<TD width="85" bgColor="#e6e6fa" colSpan="1" height="28" rowSpan="1"><FONT face="新細明體" size="2"><STRONG>性質1</STRONG></FONT></TD>
							...
							<TR>
								<TD width="85" bgColor="#e6e6fa" height="28"><FONT face="新細明體" size="2"><STRONG>保險商品類別</STRONG></FONT></TD>
								<TD width="185" bgColor="#ffffff" colSpan="3" height="28">
