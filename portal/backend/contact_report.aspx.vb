...
#End Region
    ...
    Private Sub inquire_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles inquire.Click
        ...
        If scnttype = "9" Then
            scnttype = "%"
        ElseIf scnttype = "1" Then
            scnttype = "1"
        ElseIf scnttype = "2" Then
            scnttype = "2"
        End If
        ...
        Dim url As String
        url = IFrameSrc & "&myStartDate=" & sdate1 & "&myEndDate=" & edate1 & "&status=" & status & "&cnttype=" & scnttype

        Dim s As String = "window.open('" & url + "', 'popup_window', 'width=1000,height=768,left=100,top=100,resizable=yes');"
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        '1130923
        Dim url As String
        url = IFrameSrc2 & "&myStartDate=" & sdate1 & "&myEndDate=" & edate1 & "&status=" & status & "&cnttype=" & scnttype

        Dim s As String = "window.open('" & url + "', 'popup_window', 'width=900,height=600,left=100,top=100,resizable=yes');"
        ClientScript.RegisterStartupScript(Me.GetType(), "script", s, True)
    End Sub
