...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="faq_grp.aspx.vb" Inherits="faq_grp" %>
<!-- NAME: index.tpl --><tr>
		...
		<tr>
			<td vAlign="middle" align="center">
				<table width="100%" border="0" cellpadding="3" cellspacing="0">
					<tr>
						<td width="94">&nbsp;</td>
						<td width="26%"><font size="2" color="red"><b>&gt;&gt;</b> <font size="2" color="#003366">問題群組管理</font></font></td>
						<td width="65%">&nbsp;</td>
					</tr>
				</table>
			</td>
				...
				<table id="Table4" height="320" cellSpacing="4" cellPadding="4" width="95%" border="0">
								...
								<DIV align="left">
									<asp:datagrid id="dgCart" runat="server" GridLines="None" AllowSorting="True" PageSize="3" OnCancelCommand="dgCart_Cancel"
										...
										<Columns>
											...
											<asp:HyperLinkColumn Text="編輯" DataNavigateUrlField="no" DataNavigateUrlFormatString="faq_grp.aspx?no={0}"
					...
					<TR>
						<TD align="center" bgColor="#ffffff" colSpan="4">
							<INPUT id='ittype' name="ittype" type='hidden' value='FAQ'>
