<%@ Page Language="vb" AutoEventWireup="false" Codebehind="download_grp.aspx.vb" Inherits="download_grp" %>
			...
			<tr>
				<td vAlign="middle" align="center">
					<table width="100%" border="0" cellpadding="3" cellspacing="0">
						<tr>
							<td width="94">&nbsp;</td>
							<td width="26%"><font size="2" color="red"><b>&gt;&gt;</b> <font size="2" color="#003366">下載群組管理</font></font></td>
							<td width="65%">&nbsp;</td>
						</tr>
					</table>
				</td>
									...
									<DIV align="left">
										<asp:datagrid id="dgCart" runat="server" GridLines="None" AllowSorting="True" PageSize="3" OnCancelCommand="dgCart_Cancel"
											...
											<Columns>
												...
												<asp:HyperLinkColumn Text="編輯" DataNavigateUrlField="no" DataNavigateUrlFormatString="download_grp.aspx?no={0}"
