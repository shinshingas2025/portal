...
#End Region
    ...
    Sub dgCart_Delete(ByVal s As Object, ByVal e As DataGridCommandEventArgs)
        ...
        sc.Delete(invno, Server.MapPath("../UpFile/"))
    ...
    Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        ...
        If file.ContentLength <> 0 Then
            ...
            '上傳之檔案名稱
            url_invfile = "Inv05_" & Today.Year & Today.Month & Today.Day & FileName
    ...
    Private Sub btnupdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnupdate.Click
        ...
        sc.Update(cn)
        txtResult.Text = "修改成功!"
        Response.Redirect("invest_05.aspx")
    End Sub
