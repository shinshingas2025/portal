								...
								<form id="Form1" method="post" runat="server" enctype="multipart/form-data">
									...
									<P align="left">
											...
											<TBODY>
												...
												<TR>
													...
													<TD width="185" bgColor="#ffffff" colSpan="3" height="28"><FONT face="新細明體"><FONT color="#000000" size="2"><STRONG></STRONG></FONT></FONT><FONT face="新細明體">
															<asp:label id="txtdbfile" runat="server"></asp:label><INPUT type="file" id="txtfile" name="txtfile" runat="server" style="WIDTH: 344px; HEIGHT: 22px"
																size="38"> </FONT>
													</TD>
												</TR>
												<TR>
										...
										%>
												...
												<TR>
													<TD align="left" width="173" bgColor="#ffffff" colSpan="4"><asp:label id="txtResult" runat="server" Font-Size="X-Small" ForeColor="Red"></asp:label></TD>
												</TR>
											</TBODY>
										</TABLE>
									</P>
