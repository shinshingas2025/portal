<%@ Page Language="vb" AutoEventWireup="false" Codebehind="member_01.aspx.vb" Inherits="member_01" %>
<HTML>
	<HEAD>
										...
										<TR>
											<TD vAlign="top" align="left" height="92">
												<TABLE height="112" cellSpacing="0" cellPadding="0" width="572" border="0" ms_1d_layout="TRUE">
													<TR>
														<TD>
															<TABLE id="Table2" height="82" cellSpacing="0" cellPadding="0" width="510" border="0">
																<TR>
																	...
																	<TD width="729" height="33">
																		<asp:textbox id="txtDateStart" runat="server" MaxLength="7" Width="68px"></asp:textbox><asp:label id="Label1" runat="server">─</asp:label><asp:textbox id="txtDateEnd" runat="server" MaxLength="7" Width="68px"></asp:textbox><FONT color="#3399cc">
																			<br>
																			(Ex:1000101;空白表全部)</FONT><FONT face="新細明體"></FONT>
																	</TD>
																	<TD width="136" height="33"><FONT face="新細明體"></FONT></TD>
																</TR>
																<TR>
																	...
																	<TD width="729" height="121"><FONT face="新細明體"><asp:checkbox id="CheckBox1" runat="server" Checked="True" Text="已啟動、已設定用戶號碼"></asp:checkbox><br>
																	...
																	<TD width="136" height="121"><FONT face="新細明體"></FONT></TD>
																</TR>
																<TR>
																	...
																	<TD width="729" height="88"><FONT face="新細明體"><asp:checkbox id="Checkbox6" runat="server" Checked="True" Text="個人用戶"></asp:checkbox><br>
																	...
																	<TD width="136" height="88"><FONT face="新細明體"></FONT></TD>
																</TR>
																<TR>
																	...
																	<TD width="729"><FONT face="新細明體">&nbsp;</FONT>
																		<asp:textbox id="likeContent" runat="server" Width="160px"></asp:textbox></TD>
																	<TD width="136"><asp:button id="btnSearch" runat="server" Text="查詢"></asp:button></TD>
																</TR>
																<TR>
																	...
																	<TD width="729" height="14"><FONT face="新細明體"><asp:label id="createGroup" runat="server" ></asp:label></FONT></TD>
																	<TD width="136" height="14"><FONT face="新細明體"></FONT></TD>
																</TR>
																<TR>
																	...
																	<TD width="729" height="25"><asp:label id="Creater" runat="server" ></asp:label></TD>
																	<TD width="136" height="25"><FONT face="新細明體"><asp:button id="btnPrint" runat="server" Width="43px" Text="列印"></asp:button></FONT></TD>
																</TR>
															</TABLE>
														</TD>
													</TR>
