...
#End Region
    ...
    '---------------------------------------------
        ...
        If urldwno Is Nothing Then
            ...
            If Not IsPostBack Then
                With Me.txtdwgrp
                    .DataSource = it.GetSelectStr("txtdwgrp", "DOWN")
    ...
    Dim LI As New ListItem("")
            ...
            End With
            dt = wk.Query(urldwno)
            txtdbdwgrp.Text = "目前項目:" & it.GetNameStr(CType(dt.Rows(0).Item("dwgrp"), String), "DOWN") & "(若無需修改項目則可不選擇)<br>"
    ...
    Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        Dim cm As New DownloadBO
        Dim cn As New Endownload
        Dim data() As String
        ...
        If file.ContentLength <> 0 Then
            ...
            '上傳之檔案名稱
            url_dwfile = Today.Year & Today.Month & Today.Day & FileName
            file.SaveAs(Server.MapPath("../UpFile/" & url_dwfile))
            '----------------------------------------------------------------
            cn.dwgrp = txtdwgrp.SelectedValue.ToString
            cn.dwname = txtname.Text.Trim
    ...
    Private Sub btnupdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnupdate.Click
        ...
        Response.Redirect("download_item.aspx")
    End Sub
