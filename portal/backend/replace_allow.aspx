<%@ Page Language="vb" AutoEventWireup="false" Codebehind="replace_allow.aspx.vb" Inherits="replace_allow" codePage="65001" %>
<HTML>
	<HEAD>
		<title>tmp</title>
			...
			<table cellSpacing="0" cellPadding="0" width="145" border="0">
				<tr>
					...
					<TD vAlign="top" width="120" bgColor="#0099cc">
						<P><FONT size="2">&nbsp;<FONT color="#ffffff">保險商品--允許抽換</FONT></FONT></P>
					</TD>
				</tr>
			</table>
			<FONT face="新細明體">
				<P><asp:datagrid id="dgCart" runat="server" BorderStyle="Ridge" BorderWidth="0px" CellPadding="2"
						...
						<Columns>
							...
							<asp:HyperLinkColumn Text="允許抽換" DataNavigateUrlField="faqno" DataTextField="faqno" HeaderText="操作" NavigateUrl="允許抽換"
								DataTextFormatString="允許抽換">
								<HeaderStyle ForeColor="White" Width="8%"></HeaderStyle>
							</asp:HyperLinkColumn>
							<asp:HyperLinkColumn Text="取消允許" DataNavigateUrlField="faqno" DataTextField="faqno" NavigateUrl="取消允許"
								DataTextFormatString="取消允許">
								<HeaderStyle ForeColor="White" Width="8%"></HeaderStyle>
							</asp:HyperLinkColumn>
						</Columns>
