...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="download_item.aspx.vb" Inherits="download_item" %>
<!-- NAME: index.tpl --><tr>
			...
			<tr>
				<td vAlign="middle" align="center">
					<table cellSpacing="0" cellPadding="3" width="100%" border="0">
						<tr>
							<td width="94">&nbsp;</td>
							<td width="26%"><font color="red" size="2"><b>&gt;&gt;</b> <FONT color="#003366">下載 <font size="2">
											資料管理</font></FONT></font></td>
							<td width="65%">&nbsp;</td>
						</tr>
					</table>
				</td>
									...
									<DIV align="left">
										<asp:datagrid id="dgCart" runat="server" CellSpacing="1" BorderStyle="Ridge" BorderWidth="2px"
											...
											<Columns>
												...
												<asp:HyperLinkColumn Text="檔案" DataNavigateUrlField="dwfile" DataNavigateUrlFormatString="../UpFile/{0}"
													DataTextField="dwfile" HeaderText="檔案" NavigateUrl="檔案">
													<HeaderStyle ForeColor="White" Width="20%"></HeaderStyle>
												</asp:HyperLinkColumn>
												<asp:HyperLinkColumn Text="編輯" DataNavigateUrlField="dwno" DataNavigateUrlFormatString="download_item.aspx?dwno={0}"
										...
										<TABLE id="Table5" height="216" cellSpacing="1" cellPadding="1" width="600" bgColor="#003399"
											...
											<TBODY>
												<TR>
													...
													<TD width="185" bgColor="#ffffff" colSpan="3" height="27"><asp:label id="txtdbdwgrp" runat="server"></asp:label><asp:dropdownlist id="txtdwgrp" runat="server"></asp:dropdownlist></TD>
												</TR>
												<TR>
													<TD width="80" bgColor="lavender" height="27">
														<P><FONT face="新細明體"><FONT color="#000000" size="2"><STRONG>檔案名稱</STRONG></FONT></FONT></P>
													</TD>
													<TD width="185" bgColor="#ffffff" colSpan="3" height="27"><FONT face="新細明體"></FONT><FONT face="新細明體"></FONT><FONT face="新細明體"><asp:textbox id="txtname" runat="server" Width="376px"></asp:textbox></FONT></TD>
												</TR>
												<TR>
													<TD width="80" bgColor="lavender" height="28"><FONT color="#000000" size="2"><STRONG>檔案上傳</STRONG></FONT></TD>
													<TD width="185" bgColor="#ffffff" colSpan="3" height="28"><FONT face="新細明體"><FONT color="#000000" size="2"><STRONG></STRONG></FONT></FONT><FONT face="新細明體">
															<asp:label id="txtdbfile" runat="server"></asp:label><INPUT type="file" id="txtfile" name="txtfile" runat="server" size="43">
														</FONT>
													</TD>
												</TR>
												<TR>
