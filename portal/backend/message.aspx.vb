...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            If Not IsPostBack Then
                dt = wk.Query(urlmsgno)
                txtsubject.Text = CType(dt.Rows(0).Item("msgsubject"), String)
    ...
    Sub dgCart_Update(ByVal s As Object, ByVal e As DataGridCommandEventArgs)
        ...
        msgno = dgCart.DataKeys(e.Item.ItemIndex).ToString()
        txtsubject = CType(e.Item.Cells(0).Controls(0), TextBox)
        txtenddate = CType(e.Item.Cells(1).Controls(0), TextBox)

        For Each objDR In objCartDT.Rows
            If Trim(CType(objDR("msgno"), String)) = msgno.Trim Then
                ac.msgsubject = txtsubject.Text.Trim
                ac.msgenddate = txtenddate.Text
                ac.msgno = msgno
                sc.Update(ac)
                Exit For
            End If
    ...
    Sub dgCart_Delete(ByVal s As Object, ByVal e As DataGridCommandEventArgs)
        Dim sc As New MsgBO
        Dim msgno As String
        msgno = Trim(CType(dgCart.DataKeys(e.Item.ItemIndex), String))
        sc.Delete(msgno)
        txtResult.Text = "刪除成功!"
        Call showData()
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        ...
        Dim cm As New MsgBO
        Dim cn As New Enmsg
        cn.msgsubject = txtsubject.Text.Trim
    ...
    Private Sub btnupdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnupdate.Click
        ...
        cn.msgno = Request("msgno").ToString
        cn.msgsubject = Request("txtsubject").ToString
