<%@ Page Language="vb" AutoEventWireup="false" Codebehind="revoke_allow.aspx.vb" Inherits="revoke_allow" codePage="65001" %>
<HTML>
	<HEAD>
		<title>tmp</title>
			...
			<table cellSpacing="0" cellPadding="0" width="170" border="0">
				<tr>
					...
					<TD vAlign="top" width="145" bgColor="#0099cc">
						<P><FONT size="2">&nbsp;<FONT color="#ffffff">保險商品--撤件狀態回覆</FONT></FONT></P>
					</TD>
				</tr>
			</table>
			<FONT face="新細明體">
				<P><asp:datagrid id="dgCart" runat="server" BorderStyle="Ridge" BorderWidth="0px" CellPadding="2"
						...
						<Columns>
							...
							<asp:HyperLinkColumn Text="撤件成立" DataNavigateUrlField="faqno" DataTextField="faqno" HeaderText="操作" NavigateUrl="撤件成立"
								DataTextFormatString="撤件成立">
								<HeaderStyle ForeColor="White" Width="8%"></HeaderStyle>
							</asp:HyperLinkColumn>
							<asp:HyperLinkColumn Text="取消撤件成立" DataNavigateUrlField="faqno" DataTextField="faqno" NavigateUrl="取消撤件成立"
								DataTextFormatString="取消撤件成立">
								<HeaderStyle ForeColor="White" Width="8%"></HeaderStyle>
							</asp:HyperLinkColumn>
						</Columns>
