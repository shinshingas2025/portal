<%@ Page Language="vb" AutoEventWireup="false" Codebehind="contactMgt_2.aspx.vb" Inherits="contactMgt_2" %>
						...
						<TD vAlign="top" align="center">
							...
							<TABLE id="Table3" height="476" cellSpacing="0" cellPadding="1" width="658" border="1">
								...
								<TR>
									...
									<TD colSpan="5" height="164"><FONT face="新細明體"><asp:textbox id="remark" runat="server" Width="545px" Height="154px" TextMode="MultiLine"></asp:textbox></FONT></TD>
								</TR>
								<TR>
									<TD colSpan="6">
										<P align="center"><FONT face="新細明體"><asp:button id="btnupdate" runat="server" Text="修改"></asp:button><asp:button id="btnupdatecel" runat="server" Text="返回"></asp:button><asp:button id="print" runat="server" Text="列印"></asp:button></FONT></P>
									</TD>
								</TR>
							</TABLE>
