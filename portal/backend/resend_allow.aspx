<%@ Page Language="vb" AutoEventWireup="false" Codebehind="resend_allow.aspx.vb" Inherits="resend_allow" codePage="65001" %>
<HTML>
	<HEAD>
		<title>tmp</title>
		...
		<FORM id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="170" border="0">
				<tr>
					...
					<TD vAlign="top" width="145" bgColor="#0099cc">
						<P><FONT size="2">&nbsp;<FONT color="#ffffff">保險商品--開放補正案件</FONT></FONT></P>
					</TD>
				</tr>
			</table>
			<FONT face="新細明體">
				<P><asp:datagrid id="dgCart" runat="server" BorderStyle="Ridge" BorderWidth="0px" CellPadding="2"
						...
						<Columns>
							...
							<asp:BoundColumn DataField="creater" HeaderText="保險公司">
							...
							<asp:BoundColumn DataField="faqanswer" HeaderText="商品名稱">
								<HeaderStyle ForeColor="White" Width="29%"></HeaderStyle>
							</asp:BoundColumn>
							...
							<asp:HyperLinkColumn Text="開放補正" DataNavigateUrlField="faqno" DataTextField="faqno" HeaderText="操作" NavigateUrl="開放補正"
								DataTextFormatString="開放補正">
								<HeaderStyle ForeColor="White" Width="8%"></HeaderStyle>
							</asp:HyperLinkColumn>
							<asp:HyperLinkColumn Text="取消開放" DataNavigateUrlField="faqno" DataTextField="faqno" NavigateUrl="取消開放"
								DataTextFormatString="取消開放">
								<HeaderStyle ForeColor="White" Width="8%"></HeaderStyle>
							</asp:HyperLinkColumn>
						</Columns>
