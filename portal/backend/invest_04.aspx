...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="invest_04.aspx.vb" Inherits="invest_04" %>
<!-- NAME: index.tpl --><tr>
								...
								<form id="Form1" method="post" encType="multipart/form-data" runat="server">
									<DIV align="left">
										<asp:datagrid id="dgCart" runat="server" GridLines="None" AllowSorting="True" OnDeleteCommand="dgCart_Delete"
											...
											<Columns>
												<asp:BoundColumn DataField="invname" HeaderText="股利發放情形主旨">
												...
												<asp:HyperLinkColumn Text="編輯" DataNavigateUrlField="invno" DataNavigateUrlFormatString="invest_04.aspx?invno={0}"
									...
									<P align="left">
										<TABLE id="Table5" height="216" cellSpacing="1" cellPadding="1" width="600" bgColor="#003399"
											...
											<TBODY>
												<TR>
													<TD width="133" bgColor="lavender" height="28">
														<P><FONT face="新細明體"><FONT color="#000000" size="2"><STRONG>股利發放情形主旨</STRONG></FONT></FONT></P>
													</TD>
												...
												<TR>
													<TD width="133" bgColor="lavender" height="28"><FONT color="#000000" size="2"><STRONG>附表上傳</STRONG></FONT></TD>
