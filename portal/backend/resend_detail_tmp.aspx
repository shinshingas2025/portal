<%@ Page Language="vb" AutoEventWireup="false" Codebehind="resend_detail_tmp.aspx.vb" Inherits="resend_detail_tmp" codePage="65001" %>
<HTML>
	<HEAD>
	...
	<BODY>
		<table cellSpacing="0" cellPadding="0" width="194" border="0">
			<tr>
				...
				<TD vAlign="top" width="170" bgColor="#0099cc">
					<P><FONT size="2">&nbsp;<FONT color="#ffffff">保險商品送件補正--附件建立</FONT></FONT></P>
				</TD>
			</tr>
		</table>
		<form id="form1" runat="server">
			<TABLE id="Table5" height="216" cellSpacing="1" cellPadding="1" width="600" bgColor="#003399"
				...
				<TR>
					...
					<TD width="185" bgColor="#ffffff" colSpan="3" height="28"><FONT face="新細明體"></FONT><FONT face="新細明體"></FONT><FONT face="新細明體" size="2">20060609002</FONT></TD>
				</TR>
				<TR>
					<TD width="80" bgColor="#e6e6fa" height="28"><FONT color="#000000" size="2"><STRONG>商品名稱</STRONG></FONT></TD>
					<TD width="185" bgColor="#ffffff" colSpan="3" height="28"><FONT size="2">安達保險個人傷害保險及安達保險傷害住院醫療日額保險附約(部分變更)</FONT></TD>
				</TR>
				<TR>
				...
				<TR>
					...
					<TD width="185" bgColor="#ffffff" colSpan="3" height="28"><FONT face="新細明體" size="2">2006/5/23</FONT></TD>
				</TR>
				<TR>
					<TD width="80" bgColor="#e6e6fa" height="28">
				...
				<TR>
					...
					<TD width="185" bgColor="#ffffff" colSpan="3" height="28"><FONT face="新細明體" size="2">第2次</FONT></TD>
				</TR>
				<TR>
					<TD width="80" bgColor="#e6e6fa" height="28"><FONT face="新細明體" size="2"><STRONG>保險型態</STRONG></FONT></TD>
					<TD width="185" bgColor="#ffffff" colSpan="3" height="28"><FONT size="2">部分變更商品</FONT></TD>
				</TR>
				<TR>
					<TD width="80" bgColor="#e6e6fa" height="28"><FONT face="新細明體" size="2"><STRONG>保險類別</STRONG></FONT></TD>
					<TD width="185" bgColor="#ffffff" colSpan="3" height="28"><FONT face="新細明體" size="2">傷害險</FONT></TD>
				</TR>
				<TR>
			...
			<DIV align="left"><asp:datagrid id="dgCart" runat="server" GridLines="None" AllowSorting="True" PageSize="9" OnDeleteCommand="dgCart_Delete"
					...
					<Columns>
						<asp:BoundColumn DataField="creater" HeaderText="狀態"></asp:BoundColumn>
						...
						<asp:HyperLinkColumn Text="檔案上傳" DataNavigateUrlField="invno" DataNavigateUrlFormatString="resend_file_tmp.aspx?invno={0}"
