<%@ Page Language="vb" AutoEventWireup="false" Codebehind="user_98.aspx.vb" Inherits="user_98" %>
<HTML>
	<HEAD>
									...
									<table cellSpacing="0" cellPadding="3" width="100%" border="0">
										<tr>
											<td width="666">&nbsp;<FONT size="2"><FONT color="#ff0000"><STRONG>&gt;&gt;</STRONG> </FONT>
													<FONT color="#003366">自報度數查詢 - 抄表員專用</FONT><font color="red"> (僅可查詢一個月內之資料)</font></FONT></td>
										</tr>
									</table>
														...
														<TD>
															<TABLE id="Table2" height="82" cellSpacing="0" cellPadding="0" width="600" border="0">
																<TR>
																	...
																	<TD width="610" height="24"><asp:textbox id="ApplySDATE" runat="server" Width="86px" MaxLength="8"></asp:textbox><asp:label id="Label3" runat="server">─</asp:label><asp:textbox id="ApplyEDATE" runat="server" Width="86px" MaxLength="8"></asp:textbox><FONT face="細明體" color="#3399cc" size="2">(Ex:20010809)</FONT></TD>
																	<TD width="75" height="24"><FONT face="新細明體"></FONT></TD>
																</TR>
																<TR>
																	...
																	<TD width="610" height="16"><asp:textbox id="ProcessSDATE" runat="server" Width="86px" MaxLength="8"></asp:textbox><asp:label id="Label4" runat="server">─</asp:label><asp:textbox id="ProcessEDATE" runat="server" Width="86px" MaxLength="8"></asp:textbox><FONT face="細明體" color="#3399cc" size="2">(Ex:20010809)</FONT></TD>
																	<TD width="75" height="16"><FONT face="新細明體"></FONT></TD>
																</TR>
																<TR>
																	<TD width="4" height="19">
																		<asp:label id="Label6" runat="server" CssClass="normal" Width="96px">輸入冊別</asp:label></TD>
																	<TD width="610" height="19"><FONT face="新細明體">
																			<asp:textbox id="VolNo" runat="server" Width="86px" MaxLength="8"></asp:textbox><FONT face="細明體" color="#3399cc" size="2">
																				(請輸入2碼數字,Ex:冊別A01 請輸入01;空白表全部)</FONT></FONT></TD>
																...
																<TR>
																	...
																	<TD width="610" height="19"><FONT face="新細明體"><asp:dropdownlist id="status" runat="server">
																				<asp:ListItem Value="0">未處理</asp:ListItem>
																				<asp:ListItem Value="1">已處理</asp:ListItem>
																				<asp:ListItem Value="2">全部</asp:ListItem>
																			</asp:dropdownlist></FONT>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:button id="btnSearch" runat="server" Text="查詢 "></asp:button></TD>
																	<TD width="75" height="19"></TD>
																</TR>
																<TR>
																	...
																	<TD width="610" height="14"><FONT face="新細明體"><asp:label id="createGroup" runat="server" ></asp:label></FONT></TD>
																	<TD width="75" height="14"><FONT face="新細明體"></FONT></TD>
																</TR>
																<TR>
																	...
																	<TD width="610" height="25"><asp:label id="Creater" runat="server" ></asp:label></TD>
																	<TD width="75" height="25"></FONT></TD>
																</TR>
															</TABLE>
														</TD>
													</TR>
												...
												<DIV align="left"><asp:datagrid id="dgCart" runat="server" Width="688px" CellSpacing="1" GridLines="None" BackColor="White"
														...
														<Columns>
															...
															<asp:TemplateColumn HeaderText="冊別">
																<HeaderStyle Width="5%"></HeaderStyle>
																<ItemTemplate>
																	<asp:Label id="Label7" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.Vol_no") %>'>
																	</asp:Label>
																</ItemTemplate>
															</asp:TemplateColumn>
															...
															<asp:BoundColumn DataField="CreateTime" DataFormatString="{0:yyyy-MM-dd HH:mm:ss}" ReadOnly="True" HeaderText="自報日期">
															...
															<asp:BoundColumn DataField="ProcessTime" DataFormatString="{0:yyyy-MM-dd HH:mm:ss}" ReadOnly="True" HeaderText="處理時間">
																<HeaderStyle Width="10%"></HeaderStyle>
															</asp:BoundColumn>
