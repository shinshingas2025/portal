<%@ Page Language="vb" AutoEventWireup="false" Codebehind="invest_06.aspx.vb" Inherits="invest_06" %>
								...
								<form id="Form1" method="post" encType="multipart/form-data" runat="server">
									<DIV align="left">
										<asp:datagrid id="dgCart" runat="server" GridLines="None" AllowSorting="True" OnDeleteCommand="dgCart_Delete"
											...
											<Columns>
												<asp:BoundColumn DataField="invname" HeaderText="重要決議事項主旨">
												...
												<asp:HyperLinkColumn Text="編輯" DataNavigateUrlField="invno" DataNavigateUrlFormatString="invest_06.aspx?invno={0}"
											...
											<TBODY>
												<TR>
													<TD width="130" bgColor="lavender" height="28">
														<P><FONT face="新細明體"><FONT color="#000000" size="2"><STRONG>重要決議事項主旨</STRONG></FONT></FONT></P>
													</TD>
												...
												<TR>
													...
													<TD width="185" bgColor="#ffffff" colSpan="3" height="28"><FONT face="新細明體"><FONT color="#000000" size="2"><STRONG></STRONG></FONT></FONT><FONT face="新細明體"><asp:label id="txtdbfile" runat="server"></asp:label><INPUT id="txtfile" type="file" size="42" name="txtfile" runat="server">
														</FONT>
													</TD>
												</TR>
												<TR>
