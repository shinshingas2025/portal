<%@ Page Language="vb" AutoEventWireup="false" Codebehind="invest_08.aspx.vb" Inherits="invest_08" %>
							...
							<form id="Form1" method="post" encType="multipart/form-data" runat="server">
								<DIV align="left">
									<asp:datagrid id="dgCart" runat="server" GridLines="None" AllowSorting="True" PageSize="3" OnDeleteCommand="dgCart_Delete"
										...
										<Columns>
											<asp:BoundColumn DataField="invname" HeaderText="股務代理機構主旨">
											...
											<asp:HyperLinkColumn Text="編輯" DataNavigateUrlField="invno" DataNavigateUrlFormatString="invest_08.aspx?invno={0}"
								...
								<P align="left">
									<TABLE id="Table5" height="216" cellSpacing="1" cellPadding="1" width="600" bgColor="#003399"
										...
										<TBODY>
											<TR>
												<TD width="124" bgColor="lavender" height="28">
													<P><FONT face="新細明體"><FONT color="#000000" size="2"><STRONG>股務代理機構主旨</STRONG></FONT></FONT></P>
												</TD>
											...
											<TR>
												<TD width="124" bgColor="lavender" height="28"><FONT color="#000000" size="2"><STRONG>附表上傳</STRONG></FONT></TD>
