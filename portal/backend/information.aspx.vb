...
#Region " Web Form 設計工具產生的程式碼 "
    ...
    Protected WithEvents iforsubject As System.Web.UI.WebControls.TextBox
    Protected WithEvents iforcontent As System.Web.UI.WebControls.TextBox
    ...
    Protected WithEvents iforenddate As System.Web.UI.WebControls.TextBox
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        '在這裡放置使用者程式碼以初始化網
        Dim it As New item
        Dim wk As New IforBO
        Dim dt As New DataTable
        Dim urlnewno As String
        urlnewno = Request("iforno")
        '---------------------------------------------
        ...
        Else
            ...
            If Not IsPostBack Then
                ...
                txtsubject.Text = CType(dt.Rows(0).Item("iforsubject"), String)
                txtcontent.Text = Replace(CType(dt.Rows(0).Item("iforcontent"), String), "<BR>", Chr(13))
    ...
    Sub dgCart_Update(ByVal s As Object, ByVal e As DataGridCommandEventArgs)
        ...
        Dim iforno As String
        Dim ac As New Enifor

        Dim sc As New IforBO

        iforno = dgCart.DataKeys(e.Item.ItemIndex).ToString()
        ...
        For Each objDR In objCartDT.Rows
            If Trim(CType(objDR("iforno"), String)) = iforno.Trim Then
                ac.iforsubject = txtsubject.Text.Trim
                ac.iforcontent = txtcontent.Text.Trim
                ac.iforenddate = txtenddate.Text
                ac.iforno = iforno
                sc.Update(ac)
                Exit For
            End If
    ...
    Sub dgCart_Delete(ByVal s As Object, ByVal e As DataGridCommandEventArgs)
        Dim sc As New IforBO
        Dim iforno As String
        iforno = Trim(CType(dgCart.DataKeys(e.Item.ItemIndex), String))
        sc.Delete(iforno)
        txtResult.Text = "刪除成功!"
        Call showData()
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        If checkFields() = False Then
            Exit Sub
        End If
        Dim cm As New IforBO
        Dim cn As New Enifor
        cn.iforsubject = txtsubject.Text.Trim
        cn.iforcontent = txtcontent.Text.Trim
    ...
    Private Sub btnupdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnupdate.Click
        ...
        cn.iforno = Request("iforno").ToString
        cn.iforsubject = Request("txtsubject").ToString
        cn.iforcontent = Request("txtcontent").ToString
