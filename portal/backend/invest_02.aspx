...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="invest_02.aspx.vb" Inherits="invest_02" %>
<!-- NAME: index.tpl --><tr>
								...
								<form id="Form1" method="post" encType="multipart/form-data" runat="server">
									<DIV align="left">
										<asp:datagrid id="dgCart" runat="server" GridLines="None" AllowSorting="True" PageSize="3" OnDeleteCommand="dgCart_Delete"
											...
											<Columns>
												<asp:BoundColumn DataField="invname" HeaderText="政策內容">
												...
												<asp:HyperLinkColumn Text="編輯" DataNavigateUrlField="invno" DataNavigateUrlFormatString="invest_02.aspx?invno={0}"
											...
											<TBODY>
												<TR>
													<TD width="80" bgColor="lavender" height="28">
														<P><FONT face="新細明體"><FONT color="#000000" size="2"><STRONG>政策內容</STRONG></FONT></FONT></P>
													</TD>
													<TD width="185" bgColor="#ffffff" colSpan="3" height="28"><FONT face="新細明體"></FONT><FONT face="新細明體"></FONT><FONT face="新細明體"><asp:textbox id="txtname" runat="server" Width="376px" TextMode="MultiLine" Height="96px"></asp:textbox></FONT></TD>
												</TR>
												<TR>
