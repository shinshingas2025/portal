...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="contactAdmin_2.aspx.vb" Inherits="contactAdmin_2" %>
<HTML>
	<HEAD>
												...
												<TR>
													...
													<TD width="444"><FONT face="新細明體">&nbsp;
															<asp:dropdownlist id="cnttype" runat="server">
																...
																<asp:ListItem Value="3">簡訊反映</asp:ListItem>
									...
									<tr>
										<td vAlign="top" align="center"><asp:datagrid id="dgCart" runat="server" Width="704px" CellSpacing="1" GridLines="None" BackColor="White"
												...
												<Columns>
													...
													<asp:TemplateColumn>
														<ItemTemplate>
															<a href="contactView_2.aspx?cntno=<%# DataBinder.Eval(Container, "DataItem.cntno") %>">內容</a>
														</ItemTemplate>
													</asp:TemplateColumn>
												</Columns>
