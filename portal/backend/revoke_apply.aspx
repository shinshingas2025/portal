<%@ Page Language="vb" AutoEventWireup="false" Codebehind="revoke_apply.aspx.vb" Inherits="revoke_apply" codePage="65001" %>
<HTML>
	<HEAD>
		<title>tmp</title>
			...
			<table cellSpacing="0" cellPadding="0" width="145" border="0">
				<tr>
					...
					<TD vAlign="top" width="120" bgColor="#0099cc">
						<P><FONT size="2">&nbsp;<FONT color="#ffffff">保險商品--申請撤件</FONT></FONT></P>
					</TD>
				</tr>
			</table>
			<FONT face="新細明體">
				<P><asp:datagrid id="dgCart" runat="server" BorderStyle="Ridge" BorderWidth="0px" CellPadding="2"
						...
						<Columns>
							...
							<asp:HyperLinkColumn Text="申請撤件" DataNavigateUrlField="faqno" DataTextField="faqno" HeaderText="操作" NavigateUrl="申請撤件"
								DataTextFormatString="申請撤件">
								<HeaderStyle ForeColor="White" Width="8%"></HeaderStyle>
							</asp:HyperLinkColumn>
							<asp:HyperLinkColumn Text="取消撤件" DataNavigateUrlField="faqno" DataTextField="faqno" NavigateUrl="取消撤件"
								DataTextFormatString="取消撤件">
								<HeaderStyle ForeColor="White" Width="8%"></HeaderStyle>
							</asp:HyperLinkColumn>
						</Columns>
