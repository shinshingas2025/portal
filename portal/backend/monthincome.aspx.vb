...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            If Not IsPostBack Then
                ...
                year.Text = CType(dt.Rows(0).Item("year"), Integer)
                ...
                Textbox8.Text = CType(dt.Rows(0).Item("mon08"), String)
                Textbox9.Text = CType(dt.Rows(0).Item("mon09"), String)
                Textbox10.Text = CType(dt.Rows(0).Item("mon10"), String)
                Textbox11.Text = CType(dt.Rows(0).Item("mon11"), String)
                Textbox12.Text = CType(dt.Rows(0).Item("mon12"), String)
    ...
    Sub dgCart_Update(ByVal s As Object, ByVal e As DataGridCommandEventArgs)
        ...
        Dim year As TextBox
        Dim newno As String
        Dim ac As New Enmonthincome
        Dim sc As New MonthincomeBO
        ...
        For Each objDR In objCartDT.Rows
            If Trim(CType(objDR("newno"), String)) = newno.Trim Then
                ...
                ac.mon08 = mon08.Text.Trim
                ac.mon09 = mon09.Text.Trim
                ac.mon10 = mon10.Text.Trim
                ac.mon11 = mon11.Text.Trim
                ac.mon12 = mon12.Text.Trim
    ...
    Sub dgCart_Delete(ByVal s As Object, ByVal e As DataGridCommandEventArgs)
        ...
        newno = dgCart.DataKeys(e.Item.ItemIndex)
    ...
    Private Sub btnAdd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAdd.Click
        ...
        If checkFields() = False Then
            Exit Sub
        End If
        Dim cm As New MonthincomeBO
        Dim cn As New Enmonthincome
        Dim dtYY As DataTable

        cn.year = CType(year.Text.Trim, Integer)
        ...
        cn.mon08 = Textbox8.Text.Trim
        cn.mon09 = Textbox9.Text.Trim
        cn.mon10 = Textbox10.Text.Trim
        cn.mon11 = Textbox11.Text.Trim
        cn.mon12 = Textbox12.Text.Trim
    ...
    Private Sub btnupdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnupdate.Click
        ...
        cn.mon08 = Request("Textbox8").ToString
        cn.mon09 = Request("Textbox9").ToString
        cn.mon10 = Request("Textbox10").ToString
        cn.mon11 = Request("Textbox11").ToString
        cn.mon12 = Request("Textbox12").ToString

        test = CType(sc.Update(cn), String)

        txtResult.Text = "修改成功!"

        Response.Redirect("monthincome.aspx")
    End Sub
