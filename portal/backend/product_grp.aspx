...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="product_grp.aspx.vb" Inherits="product_grp" %>
<!-- NAME: index.tpl --><tr>
			...
			<tr>
				<td vAlign="middle" align="center">
					<table width="100%" border="0" cellpadding="3" cellspacing="0">
						<tr>
							<td width="94">&nbsp;</td>
							<td width="26%"><font size="2" color="red"><b>&gt;&gt;</b> <FONT color="#003366">產品 <font size="2">
											群組管理</font></FONT></font></td>
							<td width="65%">&nbsp;</td>
						</tr>
					</table>
				</td>
					...
					<table id="Table4" height="320" cellSpacing="4" cellPadding="4" width="95%" border="0">
									...
									<DIV align="left">
										<asp:datagrid id="dgCart" runat="server" GridLines="None" AllowSorting="True" PageSize="3" OnCancelCommand="dgCart_Cancel"
											...
											<Columns>
												...
												<asp:HyperLinkColumn Text="編輯" DataNavigateUrlField="no" DataNavigateUrlFormatString="product_grp.aspx?no={0}"
											...
											<TBODY>
												...
												<TR>
													...
													<TD width="185" bgColor="#ffffff" height="34" colSpan="3"><FONT face="新細明體"><FONT color="#000000" size="2"><STRONG></STRONG></FONT></FONT><FONT face="新細明體">
															<P>
																<asp:textbox id="txtorder" runat="server" Width="32px" Height="25px"></asp:textbox>
																<font color="#660033" size="2">(如:1、2、3...)</font>
														</FONT>
									</P>
							</td>
						</tr>
						<TR>
							<TD align="center" bgColor="#ffffff" colSpan="4">
								<INPUT id='ittype' name="ittype" type='hidden' value='PD'>
