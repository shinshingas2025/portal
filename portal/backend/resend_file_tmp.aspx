<%@ Page Language="vb" AutoEventWireup="false" Codebehind="resend_file_tmp.aspx.vb" Inherits="resend_file_tmp" %>
<HTML>
	<HEAD>
		<title>tmp</title>
		...
		<FORM id="Form1" method="post" encType="multipart/form-data" runat="server">
			...
			<P align="left">
				<TABLE id="Table5" height="216" cellSpacing="1" cellPadding="1" width="600" bgColor="#003399"
					...
					<TR>
						<TD width="80" bgColor="#e6e6fa" height="28"><FONT face="新細明體" size="2"><STRONG>備註說明</STRONG></FONT></TD>
						<TD width="185" bgColor="#ffffff" colSpan="3" height="28">
							<asp:textbox id="Textbox1" runat="server" Width="376px" TextMode="MultiLine"></asp:textbox></TD>
					</TR>
					<TR>
