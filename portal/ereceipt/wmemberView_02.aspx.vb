...
#Region " Web Form 設計工具產生的程式碼 "
    ...
    Protected WithEvents lb_user_o_name As System.Web.UI.WebControls.Label
    Protected WithEvents btnreturn As System.Web.UI.WebControls.Button
    Protected WithEvents Label11 As System.Web.UI.WebControls.Label
    Protected WithEvents lb_paper As System.Web.UI.WebControls.Label
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not IsPostBack Then
            ...
            If dt.Rows.Count > 0 Then
                If IsDBNull(dt.Rows(0).Item("upd_datetime")) Then
                ...
                lb_user_o_name.Text = CType(dt.Rows(0).Item("wm_user_o_name"), String)
                ...
                Else
                    lb_tel_h.Text = "　"
                End If
                If Trim(dt.Rows(0).Item("wm_mobile")) <> "" And Trim(dt.Rows(0).Item("wm_mobile")) <> "-" Then
                ...
                lb_paper.Text = dt.Rows(0).Item("wm_paper_flag")
