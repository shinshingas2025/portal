<%@ Page Language="vb" AutoEventWireup="false" Codebehind="member_manage.aspx.vb" Inherits="member_manage" %>
									...
									<tr align="left">
										<td>
											<table height="141" cellSpacing="0" cellPadding="0" width="704" border="0">
												...
												<tr>
													<td width="114"><FONT face="新細明體">註冊日期</FONT></td>
													<td width="444">&nbsp;
														<asp:textbox id="txtDateStart" runat="server" MaxLength="7" Width="68px"></asp:textbox><asp:label id="Label1" runat="server">─</asp:label><asp:textbox id="txtDateEnd" runat="server" MaxLength="7" Width="68px"></asp:textbox><FONT color="#3399cc">(Ex:990809;空白表全部)</FONT><FONT face="新細明體"></FONT></td>
												...
												<TR>
													...
													<TD><asp:button id="inquire" runat="server" Text="查詢"></asp:button><FONT face="新細明體"></FONT></TD>
												</TR>
											</table>
										</td>
									</tr>
						...
						<tr>
							<td vAlign="top" align="center" width="748">
								<table id="Table4" height="320" cellSpacing="4" cellPadding="4" width="95%" align="left"
									border="0">
									<tr>
										<td vAlign="top" align="center"><asp:datagrid id="dgCart" runat="server" AllowSorting="True" OnDeleteCommand="dgCart_Delete" OnEditCommand="dgCart_Edit"
												Width="700px" AutoGenerateColumns="False" AllowPaging="True" DataKeyField="wm_no" ShowFooter="True" BorderStyle="Ridge"
												...
												<Columns>
													<asp:BoundColumn DataField="wm_org_flag_name" HeaderText="身份別">
														<HeaderStyle ForeColor="White" Width="5%"></HeaderStyle>
													</asp:BoundColumn>
													<asp:BoundColumn DataField="wm_id" HeaderText="身份證字號(統一編號)">
														<HeaderStyle ForeColor="White" Width="15%"></HeaderStyle>
													</asp:BoundColumn>
													<asp:BoundColumn DataField="wm_user_name" HeaderText="申請人姓名">
														<HeaderStyle ForeColor="White" Width="10%"></HeaderStyle>
													</asp:BoundColumn>
													<asp:BoundColumn DataField="wm_mobile" HeaderText="行動電話">
														<HeaderStyle ForeColor="White" Width="10%"></HeaderStyle>
													</asp:BoundColumn>
													<asp:BoundColumn DataField="wm_tel_o" HeaderText="連絡電話(O)">
														<HeaderStyle ForeColor="White" Width="10%"></HeaderStyle>
													</asp:BoundColumn>
													<asp:BoundColumn DataField="wm_tel_h" HeaderText="連絡電話(H)">
														<HeaderStyle ForeColor="White" Width="10%"></HeaderStyle>
													</asp:BoundColumn>
													<asp:BoundColumn DataField="wm_email" HeaderText="電子信箱">
														<HeaderStyle ForeColor="White" Width="25%"></HeaderStyle>
													</asp:BoundColumn>
													<asp:BoundColumn DataField="add_datetime" HeaderText="註冊日期">
														<HeaderStyle ForeColor="White" Width="15%"></HeaderStyle>
													</asp:BoundColumn>
													<asp:EditCommandColumn ButtonType="LinkButton" UpdateText="" CancelText="" EditText="新增"></asp:EditCommandColumn>
