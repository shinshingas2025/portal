...
#End Region
    ...
    Sub showData()
        ...
        objCartDT = se.UserQuery(sDateStart, sDateEnd, slikeSelect, slikeContent)
    ...
    Sub dgCart_Edit(ByVal s As Object, ByVal e As DataGridCommandEventArgs)
        ...
        Response.Redirect("member_manageMgtAdd.aspx?wm_no=" & swm_no)
    End Sub
    ...
    Sub dgCart_Delete(ByVal s As Object, ByVal e As DataGridCommandEventArgs)
        ...
        Response.Redirect("member_manageMgtDelet.aspx?wm_no=" & swm_no)
    End Sub
