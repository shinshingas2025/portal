...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="startmember_02.aspx.vb" Inherits="startmember_02" aspcompat="true" codePage="65001" %>
		...
		<table id="Table1" cellSpacing="0" cellPadding="0" width="930" border="0">
			<tr>
				<td vAlign="middle" align="center">
					...
					<P align="left"><FONT face="新細明體">您勾選要『</FONT><asp:label id="label1" runat="server" Width="130px"></asp:label><FONT face="新細明體">』的資料共</FONT><asp:label id="Label2" runat="server"></asp:label><FONT face="新細明體">筆，符合資料</FONT><asp:label id="Label3" runat="server"></asp:label><FONT face="新細明體">筆如下：</FONT>
					</P>
				</td>
			</tr>
			<tr>
