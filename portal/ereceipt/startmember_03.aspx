...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="startmember_03.aspx.vb" Inherits="startmember_03" aspcompat="true" codePage="65001" %>
		...
		<table id="Table1" cellSpacing="0" cellPadding="0" width="930" border="0">
			<tr>
				<td vAlign="middle" align="center">
					...
					<P align="left"><FONT face="新細明體">您勾選要『</FONT><asp:label id="label1" runat="server" Width="80px"></asp:label><FONT face="新細明體">』的資料共</FONT><asp:label id="Label2" runat="server"></asp:label><FONT face="新細明體">筆，符合資料</FONT><asp:label id="Label3" runat="server"></asp:label><FONT face="新細明體">筆如下：</FONT>
					</P>
				</td>
			</tr>
			<tr>
								...
								<td align="center">
									<form id="Form1" method="post" runat="server">
										<asp:datagrid id="dgCart" runat="server" BorderStyle="None" BorderWidth="1px" CellPadding="3"
											...
											BackColor="White" Width="800px" PageSize="10" AllowSorting="True" GridLines="Horizontal">
											...
											<Columns>
												...
												<asp:TemplateColumn Visible="False" HeaderText="編號">
													<ItemTemplate>
														<FONT face="新細明體">
															<asp:Label id="opencode" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.wm_open_code") %>'>
															</asp:Label></FONT>
													</ItemTemplate>
												</asp:TemplateColumn>
									...
									--%>
										...
										<p><asp:label id="Message" align="center" runat="server" Width="200px"></asp:label>
										<p>
											<TABLE id="Table5" height="216" cellSpacing="1" cellPadding="1" width="600" bgColor="#003399"
												...
												<TBODY>
													...
													<TR>
														<TD align="left" width="173" bgColor="#ffffff" colSpan="4"><asp:label id="txtResult" runat="server" ForeColor="Red"  width="296px"></asp:label></TD>
													</TR>
												</TBODY></TABLE>
									</form>
									</FORM></P></td>
