<%@ Page Language="vb" AutoEventWireup="false" Codebehind="wmemberView_01.aspx.vb" Inherits="wmemberView_01" codePage="65001" %>
															...
															<TABLE id="Table2" cellSpacing="1" cellPadding="1" width="100%" border="1">
																<TBODY>
																	...
																	<TR>
																		...
																		<TD width="211" height="24"><asp:label id="lb_upd_datetime" runat="server" Width="136px" ></asp:label></TD>
																		...
																		<TD width="211" height="24"><asp:label id="lb_add_datetime" runat="server" Width="136px" ></asp:label></TD>
																	</TR>
																	<TR>
																	...
																	<TR>
																		...
																		<TD width="211" colSpan="4" height="24"><asp:label id="lb_mobile" runat="server"></asp:label></TD>
																	</TR>
																	<TR>
																		...
																		<TD width="211" colSpan="4" height="24"><asp:label id="lb_email" runat="server"></asp:label></TD>
																	</TR>
																</TBODY></TABLE>
														</td>
													</tr>
