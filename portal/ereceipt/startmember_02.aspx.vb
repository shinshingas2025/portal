        ...
        For Each objDataGridItem In dgCart.Items
            ...
            Try
                ...
                If sWmOpenCode.Length > 0 Then
                    ...
                    Body = Body & "２.請至『會員專區』頁之『用戶申請／取消電子繳費憑證』中，新增您的用戶號碼；<br/>"
                    Body = Body & "如您不知用戶號碼，請查詢前期氣費繳費憑證。<br/><br/><br/>"
                    Body = Body & "謝謝！<br/>"
                    ...
                    If SendEmail("mail.shinshingas.com.tw", 25, True, "contactus", "22325804", MailMessage) = True Then
                        Message.Text = "未設定用戶號碼通知書己寄至您所申請的郵件信箱!"
            ...
            'Message.Text = "未設定用戶號碼通知書己寄至您所申請的郵件信箱!"
            If Message.Text = "未設定用戶號碼通知書己寄至您所申請的郵件信箱!" Then
                'no = Request.Params("no").ToString
